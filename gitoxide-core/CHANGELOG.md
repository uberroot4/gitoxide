...
### Bug Fixes
 ...
 - <csr-id-32d6bfbe6548fc699deee41895bcafff1423f117/> assure that `gix tree diff` doesn't slow down too much when shortening IDs
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `gix` ([`589ee8e`](https://github.com/GitoxideLabs/gitoxide/commit/589ee8e3338ab66fe405d85a9b0c2fd8a797212a))
    ...
    - Adapt to changes in `gix-merge` ([`278dd88`](https://github.com/GitoxideLabs/gitoxide/commit/278dd8896007a7fa3d0ec2558cc2055303486259))
    - Assure that `gix tree diff` doesn't slow down too much when shortening IDs ([`32d6bfb`](https://github.com/GitoxideLabs/gitoxide/commit/32d6bfbe6548fc699deee41895bcafff1423f117))
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `gix-traverse` ([`6862c27`](https://github.com/GitoxideLabs/gitoxide/commit/6862c27e671cbfd8caae549813ea01eeb753bd0b))
    ...
    - Adapt to changes in `gix` ([`dbb3576`](https://github.com/GitoxideLabs/gitoxide/commit/dbb35767df8c6d8382bb06dcf9b31e2c74fcedd7))
 ...
 * **Uncategorized**
    ...
    - Merge pull request #1511 from joshtriplett/upgrade-sysinfo ([`9d7da54`](https://github.com/GitoxideLabs/gitoxide/commit/9d7da54700265389cde88496d2f92a84d3cd3043))
    - Upgrade sysinfo from 0.30 to 0.31 ([`b7f4de4`](https://github.com/GitoxideLabs/gitoxide/commit/b7f4de455d01fd0e4d711822b584765620ea879a))
    ...
    - Prevent terminal windows from popping up if code is run from a graphical UI on Windows ([`1257fbd`](https://github.com/GitoxideLabs/gitoxide/commit/1257fbdd0f54eafde2546f2140e945d11fb0eb6a))
    - Merge branch 'upgrades' ([`1d37bf6`](https://github.com/GitoxideLabs/gitoxide/commit/1d37bf6a773d56eea9003aa626ced413e8e0eaa3))
    - Upgrade `rusqlite` to the latest version ([`51c4706`](https://github.com/GitoxideLabs/gitoxide/commit/51c4706db61348531759686c3d6b805b72bcdb6b))
    ...
    - Warn about hidden worktrees as well as separate repos ([`8c0448f`](https://github.com/GitoxideLabs/gitoxide/commit/8c0448f6c4384b07d57e6c0633e3f766d54d2ce2))
</details>
 ...
 * **[#1466](https://github.com/GitoxideLabs/gitoxide/issues/1466)**
    - Prepare manual release of `gitoxide-core` ([`8b09cf2`](https://github.com/GitoxideLabs/gitoxide/commit/8b09cf254e8e376907b9e26d172cb9adf98f4d6e))
 ...
 * **Uncategorized**
    ...
    - Improve wording of error message ([`4883eb1`](https://github.com/GitoxideLabs/gitoxide/commit/4883eb18383062d082303cb61fba807fe25ffb4c))
    ...
    - Avoid allocation by using new entries-iterator ([`acd46ea`](https://github.com/GitoxideLabs/gitoxide/commit/acd46eaf4f0ef04b8cc9fc79237b01f40aaf3cbe))
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `gix` ([`eff82eb`](https://github.com/GitoxideLabs/gitoxide/commit/eff82eb0c67a7e7153c6119623a8aec052661b7d))
    ...
    - Adapt to changes in `gix` ([`2d40bdf`](https://github.com/GitoxideLabs/gitoxide/commit/2d40bdf325ed5b09b0ef6fd21e8b3da47d710451))
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `gix-dir` ([`aa7c190`](https://github.com/GitoxideLabs/gitoxide/commit/aa7c1908b82e3e23859a4c663faa40ec54611919))
    ...
    - Further improvements to `gix clean` ([`e944e74`](https://github.com/GitoxideLabs/gitoxide/commit/e944e74e17355b071373ad9baa3f91ef3da08c8f))
    - Improve `gix clean` messaging ([`221bce4`](https://github.com/GitoxideLabs/gitoxide/commit/221bce46d5d282954d76ce1d02c81a326316b64f))
    - Merge branch 'status' ([`bb48c4c`](https://github.com/GitoxideLabs/gitoxide/commit/bb48c4ce22650b8c76af3b147e252ebe7cedb205))
    - Adapt to changes in `gix` ([`417f99f`](https://github.com/GitoxideLabs/gitoxide/commit/417f99fc7b144245bca0fa12e3839c3b4542936c))
    ...
    - `gix status` now shows untracked files as well. ([`e52ad78`](https://github.com/GitoxideLabs/gitoxide/commit/e52ad782f3b16a6c39f6dba1d25808fe55d26082))
    - `gix clean` is interruptable ([`4fd3173`](https://github.com/GitoxideLabs/gitoxide/commit/4fd31739b0f34947d6c4d68ae430a792af4c4e37))
    - Merge pull request #1295 from benmkw/note ([`9b71440`](https://github.com/GitoxideLabs/gitoxide/commit/9b7144017df8786ded16281518cc5b540a67130f))
    - Add attribution ([`38a0ed9`](https://github.com/GitoxideLabs/gitoxide/commit/38a0ed99b16ac5414ff4b579c0823a1b56334334))
    - Merge branch 'iter' ([`ccb607d`](https://github.com/GitoxideLabs/gitoxide/commit/ccb607dcfc76246eb6a6edbbf8c3453a19d811cf))
    - Refactor ([`ff68295`](https://github.com/GitoxideLabs/gitoxide/commit/ff68295efe7a4584368ce21292fba84b9f4cacc2))
    - User itertools join to avoid allocations ([`a4ac58e`](https://github.com/GitoxideLabs/gitoxide/commit/a4ac58e4969d07ba6a4e2062f3d5547c71d76b07))
    - Remove itertools ([`5ddbe72`](https://github.com/GitoxideLabs/gitoxide/commit/5ddbe72ba4abf310a49e101a6ff08e2f7a034315))
    - Merge branch 'status' ([`b8def77`](https://github.com/GitoxideLabs/gitoxide/commit/b8def77e91ddc82a39ec342b89f558702a8f1d8c))
    - Improve `gix clean` reporting ([`0af2fe6`](https://github.com/GitoxideLabs/gitoxide/commit/0af2fe65e0fb9726a475fc84d949a87312e0e6fc))
    - Merge branch 'dirwalk' ([`face359`](https://github.com/GitoxideLabs/gitoxide/commit/face359443ba33e8985ec1525d5ec38b743ea7a9))
    - `gix free index info` now lists EOIE and IEOT extensions. ([`a3ab5bc`](https://github.com/GitoxideLabs/gitoxide/commit/a3ab5bc24ff0eedfec5aca6df80649faf7a56d5f))
...
<csr-read-only-do-not-edit/>
 ...
 - 2 unique issues were worked on: [#1172](https://github.com/GitoxideLabs/gitoxide/issues/1172), [#1177](https://github.com/GitoxideLabs/gitoxide/issues/1177)
 ...
 * **[#1172](https://github.com/GitoxideLabs/gitoxide/issues/1172)**
    - `ein t organize` can now handles repository moves from `./repo-name` to `./repo-name/actual-repo-name`. ([`f1b33ba`](https://github.com/GitoxideLabs/gitoxide/commit/f1b33ba7518881adfe31a03c366000e1a6e0d7d4))
 * **[#1177](https://github.com/GitoxideLabs/gitoxide/issues/1177)**
    - Leave extensions in place if they are not `.git` when using `gix clone <url>`. ([`0bc9568`](https://github.com/GitoxideLabs/gitoxide/commit/0bc95684c32a053de22c06e6e45c8de5704fd8fb))
 * **Uncategorized**
    ...
    - Upgrade sysinfo ([`e06ab59`](https://github.com/GitoxideLabs/gitoxide/commit/e06ab59e1377aeeef83d107c41c0d1d144571153))
    ...
    - Merge branch 'fix-1177' ([`401b73d`](https://github.com/GitoxideLabs/gitoxide/commit/401b73dcd2235dc73e0ebf01e3fc7a28baed0c35))
    - Merge branch 'organize-into-own-child' ([`84c998b`](https://github.com/GitoxideLabs/gitoxide/commit/84c998bc6fbc8d45988ed56043ed54812c65bc4d))
    - Allow organize to move repositories into a child directory of their current location ([`15193a7`](https://github.com/GitoxideLabs/gitoxide/commit/15193a7a96a19665fc14237842918f4198637f8a))
    - Merge branch '32bit' ([`ff1542c`](https://github.com/GitoxideLabs/gitoxide/commit/ff1542cedf3072a8c7c493d454aef5cc61de6d4c))
    - Upgrade all dependencies of `gitoxide-core` ([`c8f804c`](https://github.com/GitoxideLabs/gitoxide/commit/c8f804cc02a895182697f631cf3d49692f94e516))
 ...
 * **Uncategorized**
    ...
    - Adapt to changes in `gix` related rename tracking ([`a28bf90`](https://github.com/GitoxideLabs/gitoxide/commit/a28bf90aef49d1c51308884df84bb50567aeb501))
 ...
 * **[#1050](https://github.com/GitoxideLabs/gitoxide/issues/1050)**
    - Revert "adapt to changes in `gix-attributes`" ([`aa47342`](https://github.com/GitoxideLabs/gitoxide/commit/aa47342109bf2fe2b33d7f8ac07c56aa1692936b))
 * **Uncategorized**
    - Release gitoxide-core v0.33.0, gitoxide v0.31.0 ([`db0b851`](https://github.com/GitoxideLabs/gitoxide/commit/db0b85192deb3a41c56970cfe4c5a87bfeefb8c7))
    ...
    - `gix attrs query` now allows to match directories as signalled by the trailing slash ([`0f3a4b0`](https://github.com/GitoxideLabs/gitoxide/commit/0f3a4b0f864645b94f91897507b4d2737ff1ae25))
    ...
    - `gix attrs query` now shows attributes even for paths that aren't already tracked ([`760d451`](https://github.com/GitoxideLabs/gitoxide/commit/760d451e3e2abfc13c8d11b91609dd39ccc13bc5))
    - `gix exclude query` now also displays paths that don't match existing index entries. ([`6fb851b`](https://github.com/GitoxideLabs/gitoxide/commit/6fb851b88d3da043e747753697097d79e2fce73a))
...
<csr-read-only-do-not-edit/>
 ...
 - 7 commits were understood as [conventional](https://www.conventionalcommits.org).
 - 2 unique issues were worked on: [#1003](https://github.com/GitoxideLabs/gitoxide/issues/1003), [#1023](https://github.com/GitoxideLabs/gitoxide/issues/1023)
 ...
 * **[#1003](https://github.com/GitoxideLabs/gitoxide/issues/1003)**
    - `gix remote` and `gix fetch` now fallback to the only available remote if necessary. ([`dbf778c`](https://github.com/GitoxideLabs/gitoxide/commit/dbf778cfe5423c4769123e8b7cf5efc4dce30db7))
 * **[#1023](https://github.com/GitoxideLabs/gitoxide/issues/1023)**
    - Don't use `th` in `git rev parse -e` unconditionally, use `.` instead. ([`429682d`](https://github.com/GitoxideLabs/gitoxide/commit/429682d775ba1046bc30bbd52e9d5a8dc841378f))
 * **Uncategorized**
    ...
    - Merge pull request #1024 from Byron/nix-adjustments ([`14e0763`](https://github.com/GitoxideLabs/gitoxide/commit/14e0763cbf368bda476046a0fd28be230d67b1bd))
    - Cargo-auditable build error ([`7a8f793`](https://github.com/GitoxideLabs/gitoxide/commit/7a8f79357ce99c4b86e22be166b54f7376c71469))
    - Merge branch 'yarn' ([`53bbd06`](https://github.com/GitoxideLabs/gitoxide/commit/53bbd06d2b4380452d24d2c999f43b489b7446af))
    - Adapt to changes in `gix-attributes` ([`0fac1b9`](https://github.com/GitoxideLabs/gitoxide/commit/0fac1b9843255efbc872f1692c404b51915e0285))
    ...
    - Adapt to changes in `gix` ([`9df4929`](https://github.com/GitoxideLabs/gitoxide/commit/9df4929c2508184cb7ab83cc9c7922b2c6874f55))
 ...
 * **Uncategorized**
    ...
    - `gix index entries` with tracing ([`ec1e550`](https://github.com/GitoxideLabs/gitoxide/commit/ec1e5506ebb34ab5269b67d426ec1d57f2037d29))
 ...
 * **Uncategorized**
    - Release gitoxide-core v0.30.0, gitoxide v0.28.0 ([`b61d637`](https://github.com/GitoxideLabs/gitoxide/commit/b61d6375170c500b2ec0bfbf8820f45ec3e1f2c8))
    ...
    - Add `workspace-stream` task ([`44d9df4`](https://github.com/GitoxideLabs/gitoxide/commit/44d9df4abfd555f8bc386c050c7ece0108e80558))
    ...
    - Upgrade `open` and `itertools` to latest versions ([`e0b1ba2`](https://github.com/GitoxideLabs/gitoxide/commit/e0b1ba2dca59d54f8bac4f23cc5971158daa0e6e))
    ...
    - Adapt to changes in `gix-worktree` and let checkout-exclusive use the filter pipeline. ([`5348c44`](https://github.com/GitoxideLabs/gitoxide/commit/5348c442877a778ad0bf0a3852cacf955118450f))
 ...
 * **Uncategorized**
    ...
    - Refactor ([`8a4a0af`](https://github.com/GitoxideLabs/gitoxide/commit/8a4a0af871c9a666518c65e8de683c7aec025c3b))
    ...
    - A way to store arbitrarily complex data with tracing ([`5c18293`](https://github.com/GitoxideLabs/gitoxide/commit/5c182937280f70350379b762d7996b62bbf86f01))
    - Run tasks in parallel ([`cfd8e88`](https://github.com/GitoxideLabs/gitoxide/commit/cfd8e88e428075701a162cf8da6986700fd8c5af))
    - A first example of a task that can run in parallel ([`36a3229`](https://github.com/GitoxideLabs/gitoxide/commit/36a3229a98a6a101286ce7dd2025e9cf3e69baa7))
    - Refactor ([`daf41bf`](https://github.com/GitoxideLabs/gitoxide/commit/daf41bf9ddfaf11147f14e8388b070de693e9663))
    ...
    - Adapt to changes in `gix` ([`3728e10`](https://github.com/GitoxideLabs/gitoxide/commit/3728e10cf7c252074aa141cc84fed7af33779658))
    ...
    - `ein t hours` now uses the commit-info structure to avoid parsing a commit once more. ([`329479c`](https://github.com/GitoxideLabs/gitoxide/commit/329479ca8dd3c9fa6ad862043e18726769744cfa))
    ...
    - `ein t hours` uses git-attributes to see if a file is considered binary ([`2f5e9eb`](https://github.com/GitoxideLabs/gitoxide/commit/2f5e9eb11f2719011f1cc7fdc9d3ee9257ccce32))
    - Adapt to changes in `gix` ([`2a6015b`](https://github.com/GitoxideLabs/gitoxide/commit/2a6015b482b38df18b8770ebb6741c201a304dfb))
</details>
 ...
 * **Uncategorized**
    - Release gitoxide-core v0.28.0, gitoxide v0.26.0 ([`6c4e470`](https://github.com/GitoxideLabs/gitoxide/commit/6c4e470783fb40d135b7ef76cbd31e4ce335a2a4))
    - Prepare changelog ([`df87d52`](https://github.com/GitoxideLabs/gitoxide/commit/df87d5250bd279f759fc19d28ba2f9509ab8337f))
    ...
    - Make finding bare repos with an index possible with `ein t find`. ([`500175f`](https://github.com/GitoxideLabs/gitoxide/commit/500175f9a932952dfb8b7fe2b1c786a6a8ea9e8c))
    - Adjust to changes in `gix` ([`0737d97`](https://github.com/GitoxideLabs/gitoxide/commit/0737d974ff97785dcf36cf8c5578a1e1dee0628f))
    ...
    - `gix index entries` now works on bare repositories. ([`042f2e1`](https://github.com/GitoxideLabs/gitoxide/commit/042f2e1388236e3e50b2b148afb28d59803396b5))
    - `gix attributes validate-baseline` works in bare repostiories. ([`596ff7a`](https://github.com/GitoxideLabs/gitoxide/commit/596ff7a348afa97171d20347fcdc5671081d80df))
    - Also make it possible to find bare repositories with `ein t find` ([`39b0ba5`](https://github.com/GitoxideLabs/gitoxide/commit/39b0ba5af2ae463e244b528be93fe6492d122ae5))
    ...
    - Adjust to changes in `gix-commitgraph` ([`2d71d20`](https://github.com/GitoxideLabs/gitoxide/commit/2d71d20180c3426b40491c1e0bc12361627b3d68))
    - Pack-verification doesn't show each thread anymore. ([`0a1a8a8`](https://github.com/GitoxideLabs/gitoxide/commit/0a1a8a87528d34619520251df90d88950cdba175))
    ...
    - Fix warning ([`2fac600`](https://github.com/GitoxideLabs/gitoxide/commit/2fac600c11e0615a231e31d85e1ae8799828c2e9))
</details>
 ...
 * **Uncategorized**
    - Release gitoxide-core v0.27.0, gitoxide v0.25.0 ([`234aee0`](https://github.com/GitoxideLabs/gitoxide/commit/234aee07b3693f5cf08ed375b9257b1327e0f7d1))
    - Prepare changelogs prior to release ([`a725817`](https://github.com/GitoxideLabs/gitoxide/commit/a72581797cc8a31fa9f0c8a12b59cff88a448b80))
    ...
    - Adjust to changes in `gix-attributes` ([`11c9ff0`](https://github.com/GitoxideLabs/gitoxide/commit/11c9ff07a0a8e04ca752a76a1248a5c44d3747ed))
</details>
...
<csr-read-only-do-not-edit/>
 ...
 - 10 commits were understood as [conventional](https://www.conventionalcommits.org).
 - 2 unique issues were worked on: [#792](https://github.com/GitoxideLabs/gitoxide/issues/792), [#814](https://github.com/GitoxideLabs/gitoxide/issues/814)
 ...
 * **[#792](https://github.com/GitoxideLabs/gitoxide/issues/792)**
    - `gix clone` now handles empty repositories. ([`32cfeac`](https://github.com/GitoxideLabs/gitoxide/commit/32cfeac2f4d7bb02f6ce5d01a62906aa64d3e487))
 ...
 * **Uncategorized**
    ...
    - Adjust to changes in `gix` ([`a09b63f`](https://github.com/GitoxideLabs/gitoxide/commit/a09b63f75cf3e947cdcf052fe668d10710fac1fb))
    ...
    - Adjust to changes in `gix` ([`58398fb`](https://github.com/GitoxideLabs/gitoxide/commit/58398fb3f78b619201a7ccdc758ce81d36e32b83))
    ...
    - Rather use unbounded queues to get the delimited progress bar back ([`cc73cad`](https://github.com/GitoxideLabs/gitoxide/commit/cc73cadccabda2a107acb797a0afe534efa021be))
    - Chunk-splitting didn't produce chunks correctly and starved threads. ([`82a2cdb`](https://github.com/GitoxideLabs/gitoxide/commit/82a2cdb480ed1999a06edd9fd39a40278b8af2b9))
    ...
    - Show the date of the commit when tracing a file. ([`5903371`](https://github.com/GitoxideLabs/gitoxide/commit/5903371ef3a80009eb5d5d336283b61b5966e05f))
    - Make query display less noisy. ([`ed1d8a0`](https://github.com/GitoxideLabs/gitoxide/commit/ed1d8a06be329cca643da1bc5030ddfe347eadee))
    - Leverage the database when obtaining commits in order when querying. ([`f359b38`](https://github.com/GitoxideLabs/gitoxide/commit/f359b38d1cb41795d52b6044607d3998f47bfcae))
    - Refactor ([`a2042f8`](https://github.com/GitoxideLabs/gitoxide/commit/a2042f8a1b5a0b20d624612f4a745651ca69cc3b))
</details>
 ...
 * **Uncategorized**
    ...
    - Adjust to changes in `gix` ([`2e7989f`](https://github.com/GitoxideLabs/gitoxide/commit/2e7989f67d55e42d219ba0c945d222448e56b2bc))
 ...
 * **Uncategorized**
    ...
    - Release git-repository v0.35.0, safety bump 3 crates ([`abe1e91`](https://github.com/GitoxideLabs/gitoxide/commit/abe1e91ae6b1bac5bcf767f51a4f242ae2633ecc))
    ...
    - Adjust to changes in `git-repository` ([`81f0d47`](https://github.com/GitoxideLabs/gitoxide/commit/81f0d47f10d32953e783b5c3918122a664c4687b))
</details>
 ...
 * **Uncategorized**
    ...
    - Performance improvements for line statistics in `ein t hours` ([`b702c29`](https://github.com/GitoxideLabs/gitoxide/commit/b702c298ac439a990f8d0c5aecc22deeb10dccea))
    - `ein t hours` now correctly counts removed lines when a file changes from blob to non-blob ([`3596342`](https://github.com/GitoxideLabs/gitoxide/commit/35963421e36b563a2a2890819b508e27eb5a7c85))
    - Adjust to changes in `gitoxide` for clap upgrade to 4.1 ([`3c4e0b4`](https://github.com/GitoxideLabs/gitoxide/commit/3c4e0b4997e86aa85d303da188f5eb55905bc1f2))
    ...
    - Refactor ([`d1f9388`](https://github.com/GitoxideLabs/gitoxide/commit/d1f9388b698caa9a73f88d52608b78cfedb5145c))
 ...
 * **Uncategorized**
    ...
    - Upgade jwalk for good measure ([`4ba2235`](https://github.com/GitoxideLabs/gitoxide/commit/4ba22358026bd4b2f4c129e6504af208166daf0d))
    - `gix remote ref-map` makes clear which specs are implicit. ([`9dd5659`](https://github.com/GitoxideLabs/gitoxide/commit/9dd5659c386e97900a9c2d8c28ac70cc64ed0a52))
    - Adapt to changes in `git-repository` ([`0cefadb`](https://github.com/GitoxideLabs/gitoxide/commit/0cefadbe92d170241632c69b4215a795ab172301))
    ...
    - Refactor ([`603f341`](https://github.com/GitoxideLabs/gitoxide/commit/603f341e71c021bcc0f154c2ce6c39f4e6546c12))
...
<csr-read-only-do-not-edit/>
 ...
 - 1 commit was understood as [conventional](https://www.conventionalcommits.org).
 - 1 unique issue was worked on: [#591](https://github.com/GitoxideLabs/gitoxide/issues/591)
 ...
 * **[#591](https://github.com/GitoxideLabs/gitoxide/issues/591)**
    - Provide more information to specifically discourage using `gitoxide-core` ([`e9f83ee`](https://github.com/GitoxideLabs/gitoxide/commit/e9f83ee2f393bdff6cb4b8dd1f52231e45d8eaa2))
 * **Uncategorized**
    ...
    - Adapt to changes in `git-protocol` ([`c32663e`](https://github.com/GitoxideLabs/gitoxide/commit/c32663e2306a751ac3921685d5e795beebf4627e))
    - Adapt to changes in `git-protocol` ([`c421187`](https://github.com/GitoxideLabs/gitoxide/commit/c42118771b2fba2ad135b00c2bf1e338e81ac2e0))
    ...
    - Thanks clippy ([`dd94cc5`](https://github.com/GitoxideLabs/gitoxide/commit/dd94cc5437622287b8661e1230c397935844dc6c))
    - Adapt to changes in `git-repository` ([`39c1af7`](https://github.com/GitoxideLabs/gitoxide/commit/39c1af753f3dc093a5f898cfc7ca88c630bbb5d8))
    - Adapt to changes in `git-protocol` ([`121c93f`](https://github.com/GitoxideLabs/gitoxide/commit/121c93f47165428c9a293dd2d91c1929966e7788))
    ...
    - Adapt to changes in `git-repository` ([`039bf79`](https://github.com/GitoxideLabs/gitoxide/commit/039bf796cc1dc3384c5f3b7bcdb068ca18a0e3ec))
</details>
...
<csr-read-only-do-not-edit/>
 ...
 - 8 commits were understood as [conventional](https://www.conventionalcommits.org).
 - 3 unique issues were worked on: [#450](https://github.com/GitoxideLabs/gitoxide/issues/450), [#536](https://github.com/GitoxideLabs/gitoxide/issues/536), [#XXX](https://github.com/GitoxideLabs/gitoxide/issues/XXX)
 ...
 * **[#450](https://github.com/GitoxideLabs/gitoxide/issues/450)**
    - Fix build ([`f5155e0`](https://github.com/GitoxideLabs/gitoxide/commit/f5155e0b936f64ffc2f3d4656b0aa5062baf51ac))
    - Refactor ([`4dd67db`](https://github.com/GitoxideLabs/gitoxide/commit/4dd67dbc0e668e675bc0401204a43e587067575b))
    - Adapt to changes in `git-protocol` ([`f409e4a`](https://github.com/GitoxideLabs/gitoxide/commit/f409e4af97ae33c982ad37afbae73f701fd8ab8e))
    - Adapt to changes in `git-protocol` ([`64db0b2`](https://github.com/GitoxideLabs/gitoxide/commit/64db0b20d2ef422e0ee9beb435066d4fd97e1bb1))
    - Adjust to changes in `git-protocol` ([`ffefe88`](https://github.com/GitoxideLabs/gitoxide/commit/ffefe88264773179840f23f356307238d58f5886))
    ...
    - Adjust to changes in `git-repository` ([`fc26e4c`](https://github.com/GitoxideLabs/gitoxide/commit/fc26e4c257e1fadbfa12c8c3501714ab1b7bdbcf))
    ...
    - Inform about conflicts after checking out a clone ([`91798ae`](https://github.com/GitoxideLabs/gitoxide/commit/91798ae5e163c1db5e8f6f06d54b8f4ec07c8af1))
    - Avoid showing thread progress during clone-pack-resolution ([`056f4dd`](https://github.com/GitoxideLabs/gitoxide/commit/056f4ddb21f92a098499cadc8711438e9ecae031))
    - Adjust to changes in `git-repository` ([`d2ebe34`](https://github.com/GitoxideLabs/gitoxide/commit/d2ebe3414f73c7911f3b14bad5fda54e1f460d18))
    ...
    - Fix async build ([`ae3ced2`](https://github.com/GitoxideLabs/gitoxide/commit/ae3ced2b72a3991d003965507777f7dc746a7ab8))
    ...
    - Make it possible to ignore specs that don't match when iterating mappings. ([`bc991ff`](https://github.com/GitoxideLabs/gitoxide/commit/bc991ff5b7a1c6c1b107da3b61b955e583923658))
    ...
    - Also inform about the location of the new pack and index files ([`d782ff0`](https://github.com/GitoxideLabs/gitoxide/commit/d782ff080f43e8a60e8ec522a9f5b55c583abdec))
    - Adjust fetch-progress range ([`6e2a237`](https://github.com/GitoxideLabs/gitoxide/commit/6e2a2375f84b5e3fcbc5aa85803f79d65e3d07fb))
    ...
    - First sketch of printing fetch results, but… ([`13ac9ba`](https://github.com/GitoxideLabs/gitoxide/commit/13ac9ba3846a6facba78714fbb79e2feaf5be4de))
    - First basic printing of result when no change was found ([`cd1d2aa`](https://github.com/GitoxideLabs/gitoxide/commit/cd1d2aab0ba90d0d06a0c3a3569bc4810f0323c5))
    - Better error messages if no ref-specs are provided where needed ([`981488b`](https://github.com/GitoxideLabs/gitoxide/commit/981488b413ede3442f2213632ee52f4c207629bb))
    - Fix journeytests ([`9c9df03`](https://github.com/GitoxideLabs/gitoxide/commit/9c9df03336ada4b78de7b40b51e9b1cea6d9949d))
    - Fix build ([`d034882`](https://github.com/GitoxideLabs/gitoxide/commit/d03488211ec5bd186f6d274c55cd96cfd9d119d5))
    - Fetch works, but needs more printing of information after the fact ([`57fab9a`](https://github.com/GitoxideLabs/gitoxide/commit/57fab9afe520b9e3377d51510d86815635f7533c))
    - A sketch of how fetching could work, but it fails with the line-reader for some reason ([`ac17e11`](https://github.com/GitoxideLabs/gitoxide/commit/ac17e11ce95ee6ef8fa8d89fd57534be5a8aeda0))
    ...
    - Adapt to changes in `git-pack` ([`474156f`](https://github.com/GitoxideLabs/gitoxide/commit/474156f4944763c6e53d01cffb2534791d517598))
    - Adapt to changes in `git-pack` ([`d5254c2`](https://github.com/GitoxideLabs/gitoxide/commit/d5254c21083ae70c7a41229677dc85ccd28a2719))
    - Fix build ([`d1cb6cc`](https://github.com/GitoxideLabs/gitoxide/commit/d1cb6cc06b9560cb4dd77c18c1bc9afdec21db43))
    - Allow to turn remote-filtering off. ([`38373bc`](https://github.com/GitoxideLabs/gitoxide/commit/38373bc61c938d58a9d6ed1feae86ccf36fde67d))
 ...
 * **[#XXX](https://github.com/GitoxideLabs/gitoxide/issues/XXX)**
    - `ein tool hours -l` should now count lines correctly. ([`69ef31f`](https://github.com/GitoxideLabs/gitoxide/commit/69ef31f42e7f240f764592b640638b6727b5a7e0))
 * **Uncategorized**
    ...
    - Fix build and docs ([`971fe0c`](https://github.com/GitoxideLabs/gitoxide/commit/971fe0cb437cb1dcd470574d7b7338f0dabd09ac))
    ...
    - Thanks clippy ([`59dfc7e`](https://github.com/GitoxideLabs/gitoxide/commit/59dfc7e9def4a012fa7d4f4286f86de196e3fc2c))
    - Use `git::File::write*` methods to write the index ([`3efc6dc`](https://github.com/GitoxideLabs/gitoxide/commit/3efc6dcdc53db5d25eb98bb85072ab772e60b048))
    - Adjust to changes in `git-index` ([`fc65db0`](https://github.com/GitoxideLabs/gitoxide/commit/fc65db0c66620ea0dfe2e020c34c0265560472e6))
    - Adjust to changes in `git-index` ([`fa6bcde`](https://github.com/GitoxideLabs/gitoxide/commit/fa6bcde735792fa10b66dfc7f81588bb68dcf46f))
    - Adjust to changes in `git-index` ([`b77a390`](https://github.com/GitoxideLabs/gitoxide/commit/b77a3903300442dc10ca447e62016aed2ce3f2a7))
    - Adjust to changes in `git-index` ([`dab3a45`](https://github.com/GitoxideLabs/gitoxide/commit/dab3a45aedfffbb4de016ddca46f593afc8ca115))
    - Thanks clippy ([`6be3207`](https://github.com/GitoxideLabs/gitoxide/commit/6be32079f238f6962136bf332b8451e5354cd160))
    ...
    - Auto-tree conversion in `index from-tree` ([`bae4589`](https://github.com/GitoxideLabs/gitoxide/commit/bae45895fdf6ae9f3d235d4f81b7afd8cd7c49d4))
    ...
    - Fix build ([`314b5e0`](https://github.com/GitoxideLabs/gitoxide/commit/314b5e0b39f1aec3f577ab67fdde7dd6dc487c0a))
    ...
    - Adapt to changes in `git-pack` ([`4edaec8`](https://github.com/GitoxideLabs/gitoxide/commit/4edaec8e0179b1855c4b27949c39122d3492e46a))
    ...
    - Refactor… ([`f9f5f6a`](https://github.com/GitoxideLabs/gitoxide/commit/f9f5f6ae473f553ffbc503ca11bcf47145b6fb72))
    ...
    - Print information about filtered ref-specs as well. ([`8b6ecb2`](https://github.com/GitoxideLabs/gitoxide/commit/8b6ecb2e903233742c42efb9399fa8c6f2b9c9f8))
    - Properly compute progress range of stat commits by considering skipped merges ([`2637587`](https://github.com/GitoxideLabs/gitoxide/commit/26375872d9b647e6bf6f0b6c103e74f1afec35d0))
    - Don't account for main thread which won't be busy quickly. ([`5f4215f`](https://github.com/GitoxideLabs/gitoxide/commit/5f4215f408d6b9c9002fe126dbea67f79f777151))
    - Merge branch 'fix-odb-race' ([`b862fc5`](https://github.com/GitoxideLabs/gitoxide/commit/b862fc52dd2409e912c892c7f428a571f565b64a))
    - Merge branch 'main' into fix-odb-race ([`30712dc`](https://github.com/GitoxideLabs/gitoxide/commit/30712dc9ab952d29c528ec58bcc467b425489304))
    - `ein tool hours -l|f` ignores merge commits entirely. ([`23f8402`](https://github.com/GitoxideLabs/gitoxide/commit/23f8402964b57c8928c8a53212afc58e937023ca))
    - `ein t organize` won't complain about file:// urls anymore, but skip them. ([`05387a6`](https://github.com/GitoxideLabs/gitoxide/commit/05387a6fd78b5b544766b000041a81188317e446))
    - Refactor ([`17b0462`](https://github.com/GitoxideLabs/gitoxide/commit/17b04627ef009b12265f99ce157b1e645bf51e2d))
    - Also inform about files/lines remaining ([`bd76cbd`](https://github.com/GitoxideLabs/gitoxide/commit/bd76cbd6aa44401be1f42fa920dff1da1b5f6a53))
    - `ein tool hours` now properly calculates per-user lines of code. ([`4feca8e`](https://github.com/GitoxideLabs/gitoxide/commit/4feca8e51b0dca0acefa348095363878233bf7d9))
...
<csr-read-only-do-not-edit/>
 ...
 - 27 days passed between releases.
 - 8 commits were understood as [conventional](https://www.conventionalcommits.org).
 - 3 unique issues were worked on: [#450](https://github.com/GitoxideLabs/gitoxide/issues/450), [#470](https://github.com/GitoxideLabs/gitoxide/issues/470), [#XXX](https://github.com/GitoxideLabs/gitoxide/issues/XXX)
 ...
 * **[#450](https://github.com/GitoxideLabs/gitoxide/issues/450)**
    ...
    - Don't print tags as target, as it's misleading ([`098961f`](https://github.com/GitoxideLabs/gitoxide/commit/098961f9842f8c7d6f6254eb1ffe83fed8a403ce))
    - Nicer printing of fixes ([`fec6db8`](https://github.com/GitoxideLabs/gitoxide/commit/fec6db8fc3fb13ba15b032751d0414da93adb113))
    - Adapt to changes in `git-refspec` ([`91d1a3a`](https://github.com/GitoxideLabs/gitoxide/commit/91d1a3abf02841c9b43fd8a3102375315a6db160))
    ...
    - First basic implementation of `ref-map` ([`4dbfa4c`](https://github.com/GitoxideLabs/gitoxide/commit/4dbfa4c7a06a61caa28288a354e3ca3b68aafc82))
    ...
    - Adjust to changes in `git-protocol` ([`06d45ff`](https://github.com/GitoxideLabs/gitoxide/commit/06d45ff10ec2c401ac52d77f7430a8c8c0ba93a6))
    - Remove quick-error in favor of thiserror ([`ea84e62`](https://github.com/GitoxideLabs/gitoxide/commit/ea84e62493f9a8193603fd43da0de9d581d15637))
    - Use repository configuration for calling credential helper ([`8e07784`](https://github.com/GitoxideLabs/gitoxide/commit/8e07784d5935efa62fc70085bb81259c038a7330))
    ...
    - Adjust to changes in `git-credentials` ([`dc32898`](https://github.com/GitoxideLabs/gitoxide/commit/dc32898e9dda9cb8eee2bcad31cbe1c13d31f214))
    - Adjust to changes in `git-credentials` ([`cabe40a`](https://github.com/GitoxideLabs/gitoxide/commit/cabe40a15460cffd14618d4bb936e1f2805d687a))
 * **[#470](https://github.com/GitoxideLabs/gitoxide/issues/470)**
    ...
    - Percentages for files and lines added ([`bf63a13`](https://github.com/GitoxideLabs/gitoxide/commit/bf63a139292ffe265b1d7bcbbd0c0980dc042e1e))
    - Only diff files that are probably not a binary file (as per extension). ([`2a3c5b0`](https://github.com/GitoxideLabs/gitoxide/commit/2a3c5b000493a5a4cf62a5d5e2a509bc12a9fedd))
    - Replace `flume` with `crossbeam-channel` as it's already in the dependency graph ([`e27b65a`](https://github.com/GitoxideLabs/gitoxide/commit/e27b65abfceb90cadd1902381414d9052ec6d8d0))
    - Refactor ([`e3e3211`](https://github.com/GitoxideLabs/gitoxide/commit/e3e3211e8ae3470556a12666c1c99fdd5221e887))
    - Make stat extractions interruptable ([`cb53324`](https://github.com/GitoxideLabs/gitoxide/commit/cb533241255922993bb1275428a97e6b4c3f6fdc))
    - Collect changes lines as well ([`84eb777`](https://github.com/GitoxideLabs/gitoxide/commit/84eb777e52808c7c9019a7a0b004ed4d81a8be7c))
    - Show discovered file chnages in real-time ([`0614318`](https://github.com/GitoxideLabs/gitoxide/commit/0614318c67927f84c07640234d266b8d24bc74d3))
    ...
    - Avoid binary search if there is nothing to find ([`ffd4f0f`](https://github.com/GitoxideLabs/gitoxide/commit/ffd4f0f7edcf403573044120caf789cddb38b868))
    - `ein tool hours -s` shows statistics about files added/removed/modified. ([`b8f2f8b`](https://github.com/GitoxideLabs/gitoxide/commit/b8f2f8bac8af5ea5edd774860ee06117a54a723f))
    - Working progress printing ([`67ec2c7`](https://github.com/GitoxideLabs/gitoxide/commit/67ec2c7f9a4a6cefdf7148f5c7e48a79f201c4d2))
    - First attempt to get progress information from stat worker. ([`0947c70`](https://github.com/GitoxideLabs/gitoxide/commit/0947c703f9cecc31ceba101565e6ecafb00adb08))
 ...
 * **[#XXX](https://github.com/GitoxideLabs/gitoxide/issues/XXX)**
    - `git-diff` is now included by default as part of core functionality ([`e090f84`](https://github.com/GitoxideLabs/gitoxide/commit/e090f843f5cffc8e8e47a8cac2e6fb98e4c47771))
 * **Uncategorized**
    ...
    - Speed up `ein t hours` even more by optimizing `git-mailmap`. ([`2549195`](https://github.com/GitoxideLabs/gitoxide/commit/2549195b601a2020ecdba21168ef9066a3ddfc50))
    ...
    - `ein tool hours` is (even) faster and uses half the peak memory. ([`4d0977d`](https://github.com/GitoxideLabs/gitoxide/commit/4d0977dce6ffd8adeeb0af02922cd8e04db8e94e))
    - Ein t hours: introduce string heap for cutting peak memory in half ([`d79133b`](https://github.com/GitoxideLabs/gitoxide/commit/d79133b1f70011f2a4075b557868ebcf9f8a992f))
    - Prepare for deduplicating strings ([`98465a6`](https://github.com/GitoxideLabs/gitoxide/commit/98465a61d11c6eac298d65da149338dd60004e5d))
    - Remove rayon in favor of a simple worker thread ([`5d70f87`](https://github.com/GitoxideLabs/gitoxide/commit/5d70f873661492fee540a941ce5c291d597ea918))
    ...
    - `ein tool hours -p` now shows the percentage of hours worked as well. ([`f28783b`](https://github.com/GitoxideLabs/gitoxide/commit/f28783b0d6a8ad37028960f7094c7570768d45cc))
    ...
    - Use rev_parse_single() instead of rev_parse().single() ([`09948a5`](https://github.com/GitoxideLabs/gitoxide/commit/09948a56449c372444e1ee13138128482a97b0be))
    - Merge branch 'gix_rev_parse_time_format' ([`9399fc9`](https://github.com/GitoxideLabs/gitoxide/commit/9399fc9bd80e71632d6da2cc3fec9c147eb9f640))
    - Remove explicit `git-features` crate ([`c41c94b`](https://github.com/GitoxideLabs/gitoxide/commit/c41c94bc322f60f81b144b27c520938d600487d1))
    - Remove `git-config` dependency ([`cf63d87`](https://github.com/GitoxideLabs/gitoxide/commit/cf63d87d3fc19d317988d718adf53eeaedf0c8ca))
    - Remove unnecessary git-date dependency ([`cbc9ba9`](https://github.com/GitoxideLabs/gitoxide/commit/cbc9ba949ca52c847dfa1d8e79f7686cafcac291))
    - Gix rev parse uses ISO8601 time format. ([`efefac4`](https://github.com/GitoxideLabs/gitoxide/commit/efefac4576ca8a49010c10356a828f0006551065))
    ...
    - Make sure we start out at a commit for the traversal to work ([`ce01093`](https://github.com/GitoxideLabs/gitoxide/commit/ce0109366ef46d014447c1609070d306930115dc))
 ...
 * **Uncategorized**
    ...
    - Greatly improve `gix commit describe` performance by adding an object cache ([`d07daaa`](https://github.com/GitoxideLabs/gitoxide/commit/d07daaae8ed33161097f3007057c9993546ceb75))
</details>
...
<csr-read-only-do-not-edit/>
 ...
 - 7 commits were understood as [conventional](https://www.conventionalcommits.org).
 - 3 unique issues were worked on: [#427](https://github.com/GitoxideLabs/gitoxide/issues/427), [#450](https://github.com/GitoxideLabs/gitoxide/issues/450), [#482](https://github.com/GitoxideLabs/gitoxide/issues/482)
 ...
 * **[#427](https://github.com/GitoxideLabs/gitoxide/issues/427)**
    ...
    - Adapt to changes in `git-repository` ([`ebb788c`](https://github.com/GitoxideLabs/gitoxide/commit/ebb788c5d43e16049589955858d2c687b6e0dbc6))
    - Remove `Repository::load_index()` in favor of `repo.worktree().open_index()`. ([`ea35183`](https://github.com/GitoxideLabs/gitoxide/commit/ea35183b53f2ff71bdf2270ac4f7470a85d7756f))
    - Assure desirable performance by assuring an object cache exists. ([`af32128`](https://github.com/GitoxideLabs/gitoxide/commit/af321285e359911a9503bcb3736c7fbae657bcc7))
    - Use `Display` for revision printing instead of `Debug` ([`d194f15`](https://github.com/GitoxideLabs/gitoxide/commit/d194f155212d71d7d258b5a3e63ce12e8327f158))
    - `git_revision` is now available in `revision::plumbing`. ([`4fd0968`](https://github.com/GitoxideLabs/gitoxide/commit/4fd096840ba27da6ce86678a85ede33e3be974ff))
    - Make use of `git-revision::Spec` in `RevSpec` data structure. ([`004915e`](https://github.com/GitoxideLabs/gitoxide/commit/004915ea118e3ea6b710aa405eedc6a7a5a1a1f3))
    - Adjust to change in git-revision ([`51762bb`](https://github.com/GitoxideLabs/gitoxide/commit/51762bb627a9e001a5a3eebc4ec4a7cfc30dbb9e))
    - Adjust to changes in git-revision ([`df7da1f`](https://github.com/GitoxideLabs/gitoxide/commit/df7da1f575111cd8de0155271b6d220b92174eb7))
    - Adjust to changes in `git-revision` ([`a70f262`](https://github.com/GitoxideLabs/gitoxide/commit/a70f26274bb2d67428f4917882a94a8fc8b648c8))
    - `gix rev parse` now uses `Repository::rev_parse()` ([`e191681`](https://github.com/GitoxideLabs/gitoxide/commit/e191681a9e700d8a49e2ab6ffb19cfc5f43312a5))
    - `Repository::rev_parse()` returns a `RevSpec`. ([`e2aff28`](https://github.com/GitoxideLabs/gitoxide/commit/e2aff28e818951785d933f4b55b2f1b882729cb6))
 * **[#450](https://github.com/GitoxideLabs/gitoxide/issues/450)**
    ...
    - Adapt to changes in `git-transport` and `git-url ([`4ae2390`](https://github.com/GitoxideLabs/gitoxide/commit/4ae2390578e086705c640fa74d273e1f82c9ab62))
    - Use `git-transport` async-std support and connect ([`bb90741`](https://github.com/GitoxideLabs/gitoxide/commit/bb9074140f6b79097001692c06a64ad5c76fddef))
    - Adjust to changes in `git-transport` ([`3a024ed`](https://github.com/GitoxideLabs/gitoxide/commit/3a024ed2bbab19c613349e88abc41502c5cfa8e2))
    - Refactor ([`9d9fe6c`](https://github.com/GitoxideLabs/gitoxide/commit/9d9fe6c75de3a8cacdb47e42a1829ec8c732f94f))
    - Adapt to changes in `git-url` ([`624b180`](https://github.com/GitoxideLabs/gitoxide/commit/624b1807600344f6969402f5bd193443ec1f1bd6))
 ...
 * **[#482](https://github.com/GitoxideLabs/gitoxide/issues/482)**
    - Bring back conversion from discovery kind to `git-repository::Kind` ([`ebb5bee`](https://github.com/GitoxideLabs/gitoxide/commit/ebb5bee7b71272013f43f18a5a7ce48eccb587a0))
 * **Uncategorized**
 ...
 * **[#301](https://github.com/GitoxideLabs/gitoxide/issues/301)**
    - Fix build ([`d7dac11`](https://github.com/GitoxideLabs/gitoxide/commit/d7dac11be455ee99299a8d7dfd412853f0d709f3))
    - Refactor ([`7b5fe1d`](https://github.com/GitoxideLabs/gitoxide/commit/7b5fe1de5332ca8a85741c7c0872130b5ebd31f2))
    - Adjust to changes in git-repository ([`e1dbf85`](https://github.com/GitoxideLabs/gitoxide/commit/e1dbf85999f2b6a56467419687319b79b65899a9))
    - Fix build ([`40b8d4c`](https://github.com/GitoxideLabs/gitoxide/commit/40b8d4c072b62f0c4ef3eb452578055cd332b6a9))
    ...
    - Preliminary access to a fully configured exclusion cache ([`259d015`](https://github.com/GitoxideLabs/gitoxide/commit/259d015c4c0195fb77d372545d790ea4c4d01b8a))
    ...
    - A sketch of basic Worktree support ([`732f6fb`](https://github.com/GitoxideLabs/gitoxide/commit/732f6fb0aa9cdc843087352b12bed2cd142ed6ec))
    ...
    - Fix build ([`ffe92ca`](https://github.com/GitoxideLabs/gitoxide/commit/ffe92ca3cf066c09020bf6fa875bea06552cbd0d))
 ...
 * **[#331](https://github.com/GitoxideLabs/gitoxide/issues/331)**
    - Group similarly named sections together more by not separating them with newline ([`4c69541`](https://github.com/GitoxideLabs/gitoxide/commit/4c69541cd7192ebd5bdd696a833992d5a52cd9b6))
    - Make lossy-configuration configurable ([`b0e4da6`](https://github.com/GitoxideLabs/gitoxide/commit/b0e4da621114d188a73b9f40757f59564da3c079))
    - Update README with `gix config` information ([`c19d9fd`](https://github.com/GitoxideLabs/gitoxide/commit/c19d9fdc569528972f7f6255760ae86ba99848cc))
    ...
    - Use `git-config` to write config file on initialization, including `logallrefupdates` and `precomposeunicode`. ([`7f67b23`](https://github.com/GitoxideLabs/gitoxide/commit/7f67b23b9462b805591b1fe5a8406f8d7404f372))
 ...
 * **[#427](https://github.com/GitoxideLabs/gitoxide/issues/427)**
    - Fix build ([`4355e6b`](https://github.com/GitoxideLabs/gitoxide/commit/4355e6b5092892349a3483a6eb9dede857b4c660))
    ...
    - Improve error messages related to object decoding ([`761695c`](https://github.com/GitoxideLabs/gitoxide/commit/761695cd10222eccb720812fa41d5295d506fce9))
    ...
    - Refactor ([`a3cb4da`](https://github.com/GitoxideLabs/gitoxide/commit/a3cb4da8854a8c1f4e2aa055b5bf8d0372f75834))
    - Handle 'kind' changes which completes 'explain' ([`45022a0`](https://github.com/GitoxideLabs/gitoxide/commit/45022a0efe6e71404868a7ba816c6972050098b9))
    ...
    - Start navigation implementation ([`ea1c009`](https://github.com/GitoxideLabs/gitoxide/commit/ea1c009e1b064deccf242fc60876a8535f4814b5))
    - Implement `Revision` anchors ([`a1f0e3d`](https://github.com/GitoxideLabs/gitoxide/commit/a1f0e3d463397be201f4df40184ce38b830f3bde))
 ...
 * **Uncategorized**
    ...
    - `ein tool organize` now ignores worktrees. ([`5667a7c`](https://github.com/GitoxideLabs/gitoxide/commit/5667a7c1bafcfdff1a278b3ad0e1198cd0cc4653))
    - Revert "ignore worktrees in 'organize', but…" ([`f59471f`](https://github.com/GitoxideLabs/gitoxide/commit/f59471f0cf883176594ab4635248b4029bcb6caf))
    - Ignore worktrees in 'organize', but… ([`e501c9e`](https://github.com/GitoxideLabs/gitoxide/commit/e501c9e6348e1595fee4a5e0bd712fc2433b10df))
    ...
    - Thanks clippy ([`d011d4e`](https://github.com/GitoxideLabs/gitoxide/commit/d011d4ec3b58234cc3ea07cf6808a8ce580811c5))
 ...
 * **[#298](https://github.com/GitoxideLabs/gitoxide/issues/298)**
    ...
    - `Commit::describe()` ([`654f4af`](https://github.com/GitoxideLabs/gitoxide/commit/654f4afb794a370b7cd9d9502ff6d0c3378ec417))
 * **Uncategorized**
...
<csr-read-only-do-not-edit/>
 ...
 - 14 unique issues were worked on: [#215](https://github.com/GitoxideLabs/gitoxide/issues/215), [#247](https://github.com/GitoxideLabs/gitoxide/issues/247), [#263](https://github.com/GitoxideLabs/gitoxide/issues/263), [#266](https://github.com/GitoxideLabs/gitoxide/issues/266), [#279](https://github.com/GitoxideLabs/gitoxide/issues/279), [#287](https://github.com/GitoxideLabs/gitoxide/issues/287), [#293](https://github.com/GitoxideLabs/gitoxide/issues/293), [#298](https://github.com/GitoxideLabs/gitoxide/issues/298), [#301](https://github.com/GitoxideLabs/gitoxide/issues/301), [#329](https://github.com/GitoxideLabs/gitoxide/issues/329), [#333](https://github.com/GitoxideLabs/gitoxide/issues/333), [#364](https://github.com/GitoxideLabs/gitoxide/issues/364), [#366](https://github.com/GitoxideLabs/gitoxide/issues/366), [#67](https://github.com/GitoxideLabs/gitoxide/issues/67)
 ...
 * **[#263](https://github.com/GitoxideLabs/gitoxide/issues/263)**
    - Adjust to chagne signature of peel_to_id_in_place (again?) ([`dd5341f`](https://github.com/GitoxideLabs/gitoxide/commit/dd5341f6d258c72441e84b3874eede45798d87cc))
 ...
 * **[#266](https://github.com/GitoxideLabs/gitoxide/issues/266)**
    - Upgrade dependencies ([`c301abe`](https://github.com/GitoxideLabs/gitoxide/commit/c301abe7a7f0f0a2613250c772d4cc74faca0e5e))
    ...
    - Use handle with default cache configuration in 'ein hours' ([`f71806f`](https://github.com/GitoxideLabs/gitoxide/commit/f71806f1221daaf86b6c7b8846a85a134d0ac1ce))
    - Adapt to changes in git-repository ([`fae309b`](https://github.com/GitoxideLabs/gitoxide/commit/fae309b43f5cbc2aeb6b44b40e20f09ac0af5ca1))
    - Adjustments to match changes in `git-repository` ([`117d5f8`](https://github.com/GitoxideLabs/gitoxide/commit/117d5f8625fd3af8f501e48eb0fad6d09fa814ba))
    ...
    - Adapt to changes in git-repository ([`3266c47`](https://github.com/GitoxideLabs/gitoxide/commit/3266c47a04b1cbd296df469765f4df0727062ca5))
    ...
    - Inform when multi-threaded counting is rejected ([`cc3b070`](https://github.com/GitoxideLabs/gitoxide/commit/cc3b070d18ebb257e799c16435bffb117b9262b7))
 ...
 * **[#279](https://github.com/GitoxideLabs/gitoxide/issues/279)**
    ...
    - Adjust to changes in git_pack ([`7907ca8`](https://github.com/GitoxideLabs/gitoxide/commit/7907ca83b9106384b7ced0295c9edda4dd7940c4))
    ...
    - Refactor ([`005fba7`](https://github.com/GitoxideLabs/gitoxide/commit/005fba79f2c4bc17e7eb8b655f570bb15bacae9d))
    - Consistently use `object_hash` instead of `hash_kind` ([`de4fa64`](https://github.com/GitoxideLabs/gitoxide/commit/de4fa64843e2c26b86eaaeadd9d6514c96029a9f))
    ...
    - Deal with changes to git-odb `Write` trait ([`4d67122`](https://github.com/GitoxideLabs/gitoxide/commit/4d6712210555c7ac88940be2a271471ee1e7cb97))
 ...
 * **[#287](https://github.com/GitoxideLabs/gitoxide/issues/287)**
    - Lower-case json fields for consistency ([`f6c0e6d`](https://github.com/GitoxideLabs/gitoxide/commit/f6c0e6d76c00f03bdc1c69f814c46e30af51eec7))
 ...
 * **[#293](https://github.com/GitoxideLabs/gitoxide/issues/293)**
    ...
    - Also verify the index of the default workspace ([`15b8372`](https://github.com/GitoxideLabs/gitoxide/commit/15b8372c5a36c093c0bf3193f6b5bcd764b12a66))
    ...
    - Refactor ([`3541e33`](https://github.com/GitoxideLabs/gitoxide/commit/3541e3329574fbb694450bead62b71a9af1d336e))
 ...
 * **[#298](https://github.com/GitoxideLabs/gitoxide/issues/298)**
    - Adapt to changes in `git-repository' ([`16a1c36`](https://github.com/GitoxideLabs/gitoxide/commit/16a1c360113b9bc910d5b0812384c3ab32cfc780))
    - Clarify different repository types much better ([`bbc6efe`](https://github.com/GitoxideLabs/gitoxide/commit/bbc6efeceb26050973e1425e68a52e51b9df4572))
 ...
 * **[#301](https://github.com/GitoxideLabs/gitoxide/issues/301)**
    ...
    - Fix 'tree entries' performance by not decoding every object ([`53e79c8`](https://github.com/GitoxideLabs/gitoxide/commit/53e79c88239a9191506c095294a42ead959c8af2))
    - First basic tree visualization with --recursive and flat display ([`111400f`](https://github.com/GitoxideLabs/gitoxide/commit/111400f9353d1e2c6951260eda2dbe6e5ba64ded))
    ...
    - Fix progress - there is no max value for bytes written ([`537e5aa`](https://github.com/GitoxideLabs/gitoxide/commit/537e5aaa80fb21800d8ad856595c09018428f3eb))
 ...
 * **[#329](https://github.com/GitoxideLabs/gitoxide/issues/329)**
    - In-manifest and in-lib documentation of feature toggles ([`aa3795d`](https://github.com/GitoxideLabs/gitoxide/commit/aa3795d69926c4506e5bc2d14f447d64bc4e6c2c))
 ...
 * **[#364](https://github.com/GitoxideLabs/gitoxide/issues/364)**
    ...
    - Ein tool estimate-hours with shallow clone support ([`30b22a8`](https://github.com/GitoxideLabs/gitoxide/commit/30b22a870f22a8ad124f15a7d5395a707c1c8fa4))
    - Simplify estimate-hours by just looking at the author signature ([`beb478f`](https://github.com/GitoxideLabs/gitoxide/commit/beb478fb50581139afadbec84d24ff4d419b0756))
 ...
 * **[#366](https://github.com/GitoxideLabs/gitoxide/issues/366)**
    - `ein tool estimate-hours` now supports mailmaps ([`def80df`](https://github.com/GitoxideLabs/gitoxide/commit/def80df2e165b74f4b053e4030f563902b7d34a4))
    ...
    - Unstable mailmap module ([`e3bc1b4`](https://github.com/GitoxideLabs/gitoxide/commit/e3bc1b410409a9e27894a5cac48b06d8c3295e36))
 ...
 * **Uncategorized**
    ...
    - `ein find` with support for worktree checkouts ([`3f28e20`](https://github.com/GitoxideLabs/gitoxide/commit/3f28e2037fcb07fa022220e52bcf967d6d6ef647))
    ...
    - Thanks clippy ([`804d5f1`](https://github.com/GitoxideLabs/gitoxide/commit/804d5f141787a1feac25909e17692ee626881082))
    - Merge branch 'short-id' ([`5849d5b`](https://github.com/GitoxideLabs/gitoxide/commit/5849d5b326b83f98a16cf1d956c720c7f0fd4445))
    - Thanks clippy ([`5db3993`](https://github.com/GitoxideLabs/gitoxide/commit/5db39936fc003a79f18e545a8317305fe18af74d))
    ...
    - Thanks clippy ([`3aba4b4`](https://github.com/GitoxideLabs/gitoxide/commit/3aba4b4877a11b720a02f4a246e6fa6ac6327119))
    ...
    - Keep non "git" repository name extensions ([`d33795f`](https://github.com/GitoxideLabs/gitoxide/commit/d33795f9e99d5ad7191c807e42a6fce368932f6b))
    ...
    - Fix pack/create ([`4d8de93`](https://github.com/GitoxideLabs/gitoxide/commit/4d8de93603cc143ca092a07b30dfe8660ffe8fcb))
...
<csr-read-only-do-not-edit/>
 ...
 - 5 unique issues were worked on: [#164](https://github.com/GitoxideLabs/gitoxide/issues/164), [#198](https://github.com/GitoxideLabs/gitoxide/issues/198), [#200](https://github.com/GitoxideLabs/gitoxide/issues/200), [#205](https://github.com/GitoxideLabs/gitoxide/issues/205), [#67](https://github.com/GitoxideLabs/gitoxide/issues/67)
 ...
 * **[#164](https://github.com/GitoxideLabs/gitoxide/issues/164)**
    - Rename path::is_git to path::is ([`ac3b9ef`](https://github.com/GitoxideLabs/gitoxide/commit/ac3b9efb7b90958274ce55800959d930f8641115))
    - Rename ObjectIdExt::ancestors_iter() to *::ancestors() ([`a19567e`](https://github.com/GitoxideLabs/gitoxide/commit/a19567eceab0dd7f5478b83c2ff9ce79754db308))
 * **[#198](https://github.com/GitoxideLabs/gitoxide/issues/198)**
    - A changelog for gitoxide-core ([`b9f6a37`](https://github.com/GitoxideLabs/gitoxide/commit/b9f6a37b9c27f2405694795adb476c01574b31ed))
    ...
    - Set package cache via RepositoryAccessExt ([`66292fd`](https://github.com/GitoxideLabs/gitoxide/commit/66292fd1076c2c9db4694c5ded09799a0be11a03))
    - Prepare for configurable pack cache ([`7d2b6b6`](https://github.com/GitoxideLabs/gitoxide/commit/7d2b6b66e09ff39727fccd68d190679b52d90126))
 * **[#200](https://github.com/GitoxideLabs/gitoxide/issues/200)**
    - Feat: Add --reference/-r flag to gixp pack-receive ([`637d12c`](https://github.com/GitoxideLabs/gitoxide/commit/637d12cf368e044f59ccde37c6365d9528d2c43f))
 ...
 * **[#67](https://github.com/GitoxideLabs/gitoxide/issues/67)**
    ...
    - Use Easy in the one spot where it is possible… ([`6a97bfa`](https://github.com/GitoxideLabs/gitoxide/commit/6a97bfabcec6597efe9282e6d5c9f0ac3ada61dc))
    - Try to create persistent Easy iterator, but can't make it Send… ([`54a64a5`](https://github.com/GitoxideLabs/gitoxide/commit/54a64a588ff72515451a3d0343306ac4abe1cb35))
 ...
 * **Uncategorized**
    ...
    - Fix immediate dereference warning ([`0456312`](https://github.com/GitoxideLabs/gitoxide/commit/0456312dddbd9ffd01e29c6705bb794cb1abb414))
    ...
    - Bump git-repository v0.10.0 ([`5a10dde`](https://github.com/GitoxideLabs/gitoxide/commit/5a10dde1bcbc03157f3ba45104638a8b5b296cb9))
    - Release git-repository v0.9.1 ([`262c122`](https://github.com/GitoxideLabs/gitoxide/commit/262c1229d6d2d55c70fe0e199ab15d10954d967b))
</details>
 ...
 * **Uncategorized**
    - Release gitoxide-core v0.10.5 ([`590e59b`](https://github.com/GitoxideLabs/gitoxide/commit/590e59b2b41a419574443e6b850bdb119a172279))
    - Bump git-repository v0.9.0 ([`b797fc1`](https://github.com/GitoxideLabs/gitoxide/commit/b797fc10f3f3d1fbc23916a4ff6e5e860e2dd4ed))
    - [repository #193] Add feature flags for async/blocking ([`57f482c`](https://github.com/GitoxideLabs/gitoxide/commit/57f482c59ac47b7a5f1abf01b4a3e25364e061c2))
</details>
 ...
 * **Uncategorized**
    - Release gitoxide-core v0.10.4 ([`5ae584c`](https://github.com/GitoxideLabs/gitoxide/commit/5ae584c65cc6e9ad306f077abb609159a15c6375))
    ...
    - [repository #185] support for initializing bare repositories ([`9e8a39e`](https://github.com/GitoxideLabs/gitoxide/commit/9e8a39e3cbd620bd48f379743df0d5783c33a86f))
    - [repository #185] refactor ([`63089ff`](https://github.com/GitoxideLabs/gitoxide/commit/63089ff356ea0f62963ae213ea0dbb09f891ada6))
    - [repository #185] refactor repository initialization… ([`5ff7eaa`](https://github.com/GitoxideLabs/gitoxide/commit/5ff7eaa86bddfa94aec97355a5d6adb117045693))
</details>
 ...
 * **Uncategorized**
    - Release gitoxide-core v0.10.3 ([`e132680`](https://github.com/GitoxideLabs/gitoxide/commit/e1326808a24fa7e797106cbd4bf3f34aba59b148))
    ...
    - Bump git-repository v0.8.0 ([`cdb45ff`](https://github.com/GitoxideLabs/gitoxide/commit/cdb45ffa0810e9fcc9fd25bff7b696c2d27eeef5))
    ...
    - [stability #171] Simply commit on git-ref/git-config stability tier 1… ([`f6560ff`](https://github.com/GitoxideLabs/gitoxide/commit/f6560ffe8b9280c7e9c32afe0294ea3ee169dcf5))
    ...
    - [stability #171] Don't leak unstable plumbing crates in git-repository… ([`71eb30f`](https://github.com/GitoxideLabs/gitoxide/commit/71eb30f1caa41c1f9fe5d2785b71c9d77922c2af))
    ...
    - [pack #67] Optimize caches based on cache debugging ([`1271c01`](https://github.com/GitoxideLabs/gitoxide/commit/1271c01d2635ab49474add61a9feb78b98bd6180))
    ...
    - [repository #165] prepare for writing light docs for Easy ([`f8834c9`](https://github.com/GitoxideLabs/gitoxide/commit/f8834c9c8d2ab2ce87857c6773c6204f60df240e))
    - [repository #165] refactor ([`3a0160e`](https://github.com/GitoxideLabs/gitoxide/commit/3a0160ed1c5bc33d330ad4e9189c4937d194e98d))
    - Thanks clippy ([`1f2d458`](https://github.com/GitoxideLabs/gitoxide/commit/1f2d4584f8b650f7e751c8d2df9a5d27725f4f2f))
    - [smart-release #162] rename git-repository::object -> objs ([`ac70d81`](https://github.com/GitoxideLabs/gitoxide/commit/ac70d81791cad04ffdeb04916d7a2a6b533eee6c))
</details>
 ...
 * **Uncategorized**
    - Release gitoxide-core v0.10.2 ([`b96a518`](https://github.com/GitoxideLabs/gitoxide/commit/b96a518610256bb2a684c940908aca26089db54b))
 ...
 * **Uncategorized**
    - Release gitoxide-core v0.10.1 ([`8b21d82`](https://github.com/GitoxideLabs/gitoxide/commit/8b21d8214ddc0ad05ff559261aedb4a010ba8726))
 ...
 * **[#83](https://github.com/GitoxideLabs/gitoxide/issues/83)**
    - [organize] Auto-strip .git suffix for non-bare repos ([`ea0ecc2`](https://github.com/GitoxideLabs/gitoxide/commit/ea0ecc2f9b0dc25bbaa7788aac4eeed566f075cb))
 * **Uncategorized**
    - (cargo-release) version 0.10.0 ([`310dd22`](https://github.com/GitoxideLabs/gitoxide/commit/310dd22cc5a01980ca604a0110e78d9b804902a6))
    - (cargo-release) version 0.7.0 ([`1c5dfb8`](https://github.com/GitoxideLabs/gitoxide/commit/1c5dfb86028f266435475ca8bdddc57f95002330))
    - [core] refactor ([`e3d708f`](https://github.com/GitoxideLabs/gitoxide/commit/e3d708f953f0e88180d3c2c6bd7c028e07faa583))
    - [core] refactor ([`869d162`](https://github.com/GitoxideLabs/gitoxide/commit/869d162276ec5dbc9e8b02875dd4695a9e5256cb))
    - [gitoxide-core] avoid lossy path conversions ([`63c2951`](https://github.com/GitoxideLabs/gitoxide/commit/63c2951970391fb7a708bf874661417a51a4cb97))
    ...
    - Bump serde_json from 1.0.64 to 1.0.65 ([`9117feb`](https://github.com/GitoxideLabs/gitoxide/commit/9117feb5a228fa62f6f17fc4a0918717ccdb0b14))
    - [ref #140] do actual tag peeling in programs that matter ([`e404852`](https://github.com/GitoxideLabs/gitoxide/commit/e40485233ee7a32c11426665a3d50f939d9637eb))
    ...
    - [pack] fix build ([`e680854`](https://github.com/GitoxideLabs/gitoxide/commit/e680854b12603ea898713e900a6b4407e93ebe91))
    ...
    - [pack] support poor reference resolution if input is not an object hash… ([`1b985a1`](https://github.com/GitoxideLabs/gitoxide/commit/1b985a195e09c5681a6b6732c9a23895053dbcd2))
    ...
    - [ref] fix build ([`0b732e1`](https://github.com/GitoxideLabs/gitoxide/commit/0b732e1349760eebf9d954fe7904d3c4b218b8b2))
    ...
    - [ref] fix build ([`83002df`](https://github.com/GitoxideLabs/gitoxide/commit/83002df0296a431de839ebb3522f57d42a17515f))
    ...
    - Bump anyhow from 1.0.41 to 1.0.42 ([`352e468`](https://github.com/GitoxideLabs/gitoxide/commit/352e4689959dee169f08b8fbd7be3c1f234202b8))
    - Bump async-io from 1.4.1 to 1.6.0 ([`99e4732`](https://github.com/GitoxideLabs/gitoxide/commit/99e4732f5148787b767afc6ad57666e31faac960))
    ...
    - Fix build ([`ea2bfac`](https://github.com/GitoxideLabs/gitoxide/commit/ea2bfac65f742ca7617bc77a50376c29156c4ea5))
    ...
    - [hours] use new interrupt::Iter; refactor ([`2355f0b`](https://github.com/GitoxideLabs/gitoxide/commit/2355f0b2de4a6d7b1e206aa2a445814947983e55))
    - [pack-create] also show throughput ([`74d8d57`](https://github.com/GitoxideLabs/gitoxide/commit/74d8d57f5da84b55219c2d3b115709dc0b422897))
    - [tempfile] interruptible traversal ([`4eeaa1b`](https://github.com/GitoxideLabs/gitoxide/commit/4eeaa1bb9ca4af2eb21807007eabeb714c98fdfe))
    - [pack-create] better handling of input paths ([`1825e1a`](https://github.com/GitoxideLabs/gitoxide/commit/1825e1a68d2a3274b0cc7d6ae56a31cb8145d944))
    - [pack-create] progress for ancestor traversal ([`9349286`](https://github.com/GitoxideLabs/gitoxide/commit/9349286c3afa89a472e33d6281414dd6bf2b90a2))
    ...
    - [pack] validate tips as well… ([`ec8864f`](https://github.com/GitoxideLabs/gitoxide/commit/ec8864ff23f18a00fe39d5d0061a1ab73810e283))
    - [pack] refactor ([`18cabb8`](https://github.com/GitoxideLabs/gitoxide/commit/18cabb8618ffc324412302bfda208948abffb61f))
    - [pack] Force single-threading (with toggle) for counting phase… ([`8d3ba0b`](https://github.com/GitoxideLabs/gitoxide/commit/8d3ba0b863f82d4eed0d9ca1ddf439f6feaf5041))
    ...
    - [pack] gixp pack-create uses in-order adapter as well ([`365c582`](https://github.com/GitoxideLabs/gitoxide/commit/365c58286b9e09c9a8b1b5d6ee3b76484a458ca7))
    - [pack] refactor ([`cfdf802`](https://github.com/GitoxideLabs/gitoxide/commit/cfdf8021ea1448ac4844b1f3bf252fefde2572fa))
    - [pack] print the pack file name even if there is no output directory ([`832fa29`](https://github.com/GitoxideLabs/gitoxide/commit/832fa291595aaae7f7862d95bb1cbebcc34f2271))
    - [pack] refactor ([`9d9def3`](https://github.com/GitoxideLabs/gitoxide/commit/9d9def30784a1b90f27c8181bfb0b0ba4ed4f1c8))
    - [pack] pack-create --output-directory is now optional ([`2150be8`](https://github.com/GitoxideLabs/gitoxide/commit/2150be816f8a9d0ec049841045c904be1bb57ed6))
    - [pack] print statistics for entries iteration as well ([`eb6554b`](https://github.com/GitoxideLabs/gitoxide/commit/eb6554b84131a09e5779edee302709c8ab62f47d))
    - [pack] add --statistics flag to pack-create ([`51a3077`](https://github.com/GitoxideLabs/gitoxide/commit/51a307730b8514acffa75c78ecca3f02b1eb467b))
    - Refactor ([`24697bc`](https://github.com/GitoxideLabs/gitoxide/commit/24697bc66363f8e8b1ff14a59fdf303ffdab132d))
    - [async-receive] refactor ([`7e28831`](https://github.com/GitoxideLabs/gitoxide/commit/7e288316a4cc402bd32489dbf5ca0050f84cfb18))
    - Bump anyhow from 1.0.40 to 1.0.41 ([`f6d48c8`](https://github.com/GitoxideLabs/gitoxide/commit/f6d48c8c0ad2d92b587ba9cfc5f6e941203c7c4d))
    ...
    - Bump itertools from 0.10.0 to 0.10.1 ([`b54f21d`](https://github.com/GitoxideLabs/gitoxide/commit/b54f21da9d41aa4fc67e5b1bf7ab979ec1bd9760))
    - [async-client] refactor ([`e7d115c`](https://github.com/GitoxideLabs/gitoxide/commit/e7d115c4be758b48172b07d94139810b6fcc7fa3))
    ...
    - [async-client] refactor ([`89e6f66`](https://github.com/GitoxideLabs/gitoxide/commit/89e6f66e6e549fcc9bf72e4e837ff4e3dce66d2d))
    - Revert "[async-client] FAIL with the brutal copy-paste way" ([`7f29adc`](https://github.com/GitoxideLabs/gitoxide/commit/7f29adc2936e1266a0e2c698c1a4677cf822a5f6))
    - [async-client] FAIL with the brutal copy-paste way ([`b91ecb5`](https://github.com/GitoxideLabs/gitoxide/commit/b91ecb536c9c3e1a77647025f7a72fb098e83082))
    - Revert "[async-client] the beginning of an unholy transformation…" ([`c8423a8`](https://github.com/GitoxideLabs/gitoxide/commit/c8423a83b5212b5381ae03accf386be2f882e78c))
    - [async-client] the beginning of an unholy transformation… ([`1f314df`](https://github.com/GitoxideLabs/gitoxide/commit/1f314df4f0101bc3970201b66298afa8a35bf22c))
    ...
    - [async-client] refactor ([`dc742df`](https://github.com/GitoxideLabs/gitoxide/commit/dc742dfbc877f4a39b5659ea4960408ce0a1d247))
    - [async-client] Unblock printing in pack-receive ([`156bed6`](https://github.com/GitoxideLabs/gitoxide/commit/156bed6be1d830eb853d90dcb98c81978725d958))
    - [async-client] Sketch of (partially blocking) pack-receive ([`e58859d`](https://github.com/GitoxideLabs/gitoxide/commit/e58859d133ee23b098df9107b6da5c0cc9bb696a))
    - [async-client] ls-remote in async (but for git protocol only) ([`fd8edca`](https://github.com/GitoxideLabs/gitoxide/commit/fd8edca42a58a901e749d599eb552315d7b24a78))
    - [async-client] basic git_connect functionality using async_io/async_net ([`af60297`](https://github.com/GitoxideLabs/gitoxide/commit/af60297cf2b80d862880a2178e08f3f23b796f1d))
    ...
    - [async-client] frame from A to Z to actually implement it… ([`ac4715c`](https://github.com/GitoxideLabs/gitoxide/commit/ac4715c53798c8438fb30802d6b83c868915522b))
    - Separate networking via feature toggles and pass that through in the main crate ([`2c749f1`](https://github.com/GitoxideLabs/gitoxide/commit/2c749f10dd03ea0b027fb046e8c40c77869fb2e9))
    - [git-protocol] refactor ([`94d7be4`](https://github.com/GitoxideLabs/gitoxide/commit/94d7be4a16f2c2e68a9dacf120eef7a417a8a6b9))
    - [gix-organize] fast-prefilter + close look at the repository itself ([`eda440a`](https://github.com/GitoxideLabs/gitoxide/commit/eda440ab7efc81749b20a0f21a46825c945ff6db))
    - This version fails to detect any git repo ([`8802fa7`](https://github.com/GitoxideLabs/gitoxide/commit/8802fa7e28ea8fcd3ef8dbca84be4e1f55eca665))
    - [gix-organize] use git-repository a little more ([`20f76a5`](https://github.com/GitoxideLabs/gitoxide/commit/20f76a5fc93c9a59e26688dce3e82114ccaeffe3))
    - Revert 'gix-organize' to normal thanks to performance regression ([`eda452e`](https://github.com/GitoxideLabs/gitoxide/commit/eda452e14564e802e9314d94993ae8c8590c5301))
    - (cargo-release) version 0.6.0 ([`d35c55d`](https://github.com/GitoxideLabs/gitoxide/commit/d35c55d8ff4b52e25befb8bff839d805b9f3caf4))
    - Thanks clippy ([`6a80d5c`](https://github.com/GitoxideLabs/gitoxide/commit/6a80d5c02d01ab1fc6388eb0eb79d0a4407efab6))
    - [git-repository] gitoxide-core uses more of git-repository ([`bb5b074`](https://github.com/GitoxideLabs/gitoxide/commit/bb5b0747dfd3a3985a904b7748f296a591fcb26e))
    - [git-repository] replaces git-features and git-protocol in gitoxide-core ([`081d20f`](https://github.com/GitoxideLabs/gitoxide/commit/081d20f927f222daa69f2a1a492957fd3146bfc1))
    - Refactor ([`2ba9f91`](https://github.com/GitoxideLabs/gitoxide/commit/2ba9f915035a518bef3eb8b0ed1c9972c4a47cfa))
    - [git-repository] used by gix-hours ([`24e0258`](https://github.com/GitoxideLabs/gitoxide/commit/24e0258b9691b82df5c35a35111d19df56087cdc))
    - [git-repository] refactor ([`b5ebcfa`](https://github.com/GitoxideLabs/gitoxide/commit/b5ebcfa278a0be85ea10893fd40a8b3e2e28efd5))
    - [git-repository] now used by gixp-organize ([`aa91fad`](https://github.com/GitoxideLabs/gitoxide/commit/aa91fad3cf237f6d6f9d588ed390baa6e55f6540))
    ...
    - Configure git-features properly for gitoxide-core… ([`251e690`](https://github.com/GitoxideLabs/gitoxide/commit/251e69030c2c25493a7e2ff0cb79ca01dfa228f5))
    ...
    - Prevent pack-index-from-data to block if stdin is a terminal ([`39dec0e`](https://github.com/GitoxideLabs/gitoxide/commit/39dec0e25b23162cfd8171bc44477c4d936fc00a))
    - [pack-gen] release a little memory, hopefully ([`f25293a`](https://github.com/GitoxideLabs/gitoxide/commit/f25293ae7885a21db72b84a3aa49eca3aafbdaef))
    ...
    - [pack-gen] a lot more progress, even though it's not perfect yet ([`480f8b7`](https://github.com/GitoxideLabs/gitoxide/commit/480f8b720d84502bddd06cdbb35bf5cb69f9249d))
    ...
    - [pack-gen] better progress ([`fdee381`](https://github.com/GitoxideLabs/gitoxide/commit/fdee381073459dc7d1e2e964a930aaf8db36def5))
    ...
    - [pack-gen] Try to just ignore the amount of objects inside… ([`918b222`](https://github.com/GitoxideLabs/gitoxide/commit/918b222343dbcb5fb0177526a997d0f3cb4ac585))
    - Thanks clippy ([`89b1ee4`](https://github.com/GitoxideLabs/gitoxide/commit/89b1ee48d4c93e8ecee7630bc894c8ca994cb989))
    - [pack-gen] And it shows we really need to let the traversal be done first ([`a870eb2`](https://github.com/GitoxideLabs/gitoxide/commit/a870eb2b46a95e8ea69632eceef3fc4e37bbac4c))
    - [pack-gen] And now it creates an entries iterator ([`27c9bc1`](https://github.com/GitoxideLabs/gitoxide/commit/27c9bc1e8a254689d6c337677f71d51518f6800e))
    - [pack-gen] A step further, but it looks like input object iteration is tricky ([`abf4276`](https://github.com/GitoxideLabs/gitoxide/commit/abf427674805f8624ec381a00d8c70c569515878))
    - [pack-gen] Frame for plumbing command ([`a2203ca`](https://github.com/GitoxideLabs/gitoxide/commit/a2203ca7a403ece79dda5c568f0bf6da34535882))
    ...
    - [organize] Be clear about what the traversal really does ([`ed945ab`](https://github.com/GitoxideLabs/gitoxide/commit/ed945abfd80a4e5f994a3dee1b1deae30f57a3aa))
    - Refactor ([`ef80fd6`](https://github.com/GitoxideLabs/gitoxide/commit/ef80fd693204d42fdc125ea89f1c26643e99bde9))
</details>
 ...
 * **Uncategorized**
    - (cargo-release) version 0.9.0 ([`e6cdd84`](https://github.com/GitoxideLabs/gitoxide/commit/e6cdd8423a57b8b3982adb168c2652676df5fa37))
    ...
    - [hours-tool] interruptability of long-running commit interations ([`4fd8a63`](https://github.com/GitoxideLabs/gitoxide/commit/4fd8a63d82e87e2a9f3b0268726d08e7b954942c))
    - Add missing docs; add local-only snapshot file ([`7c56366`](https://github.com/GitoxideLabs/gitoxide/commit/7c56366f4d34e67cfd31dbbcdb6f96ba61fd1668))
    - [hours-tool] Better error messages ([`86b4570`](https://github.com/GitoxideLabs/gitoxide/commit/86b4570effdb756d86c105926ae0dc942399981c))
    - [hours-tool] integrate progress, remove direct writes to stderr ([`2778447`](https://github.com/GitoxideLabs/gitoxide/commit/27784478c6e365bc92cb0ae7d7b372f073c47293))
    - [hours-tool] bring in all the code, mostly unchanged. ([`df16b3c`](https://github.com/GitoxideLabs/gitoxide/commit/df16b3c269c0a2fa4d487988fd4fdd029b3a26f7))
    - [hours-tool] hookup new gitoxide-core command ([`680f274`](https://github.com/GitoxideLabs/gitoxide/commit/680f2742a04749a9d692741381b4c662f28f3179))
    ...
    - Don't mention skips anymore… ([`afb87d9`](https://github.com/GitoxideLabs/gitoxide/commit/afb87d9be442a1f62a069ed58948e49cd7595a3a))
    ...
    - Pack-verify: be explicit about pack-cache choice in relation to algorithm ([`e7971a9`](https://github.com/GitoxideLabs/gitoxide/commit/e7971a924df0ab958d56239f48eaafda30f15159))
...
<csr-read-only-do-not-edit/>
 ...
 - 2 commits were understood as [conventional](https://www.conventionalcommits.org).
 - 1 unique issue was worked on: [#63](https://github.com/GitoxideLabs/gitoxide/issues/63)
 ...
 * **Uncategorized**
    - (cargo-release) version 0.5.0 ([`02df134`](https://github.com/GitoxideLabs/gitoxide/commit/02df1345a22889a573adfc1be80bda271b2dc9a5))
    - (cargo-release) version 0.8.0 ([`1a2a5cc`](https://github.com/GitoxideLabs/gitoxide/commit/1a2a5cc093139cecb1516e8235f087ad12cfb703))
    ...
    - Merge branch 'daniel-levin/main' into main ([`1e727af`](https://github.com/GitoxideLabs/gitoxide/commit/1e727afd9bce7bc4b33f094ccf5b4b94376dea72))
    - Added [directory] argument to init. ([`62f8dc6`](https://github.com/GitoxideLabs/gitoxide/commit/62f8dc62ec3e76efd7311ced32094035856dbcbb))
    ...
    - Thanks clippy ([`f25598a`](https://github.com/GitoxideLabs/gitoxide/commit/f25598a82256d2c7d538e9be90437cb5ca8c973f))
    ...
    - Make it work with bare and non-bare repositories ([`b85a389`](https://github.com/GitoxideLabs/gitoxide/commit/b85a3891a08248aaa0d7ec429940c9793a2ddcd1))
    - Make client state meaning explicit ([`0f4265f`](https://github.com/GitoxideLabs/gitoxide/commit/0f4265fa93060f47637ac7e9bd286d4918b3db62))
    - [gitoxide-core] Fix find_origin_remote location ([`a3c19fc`](https://github.com/GitoxideLabs/gitoxide/commit/a3c19fcfdf144119caf469c0d18278a1578c483e))
    ...
    - [gitoxide-core] Use git-config as dependency ([`c567925`](https://github.com/GitoxideLabs/gitoxide/commit/c567925906c73a00753f4ddb6bcbd64d99d78885))
    - Make 'find' reproducable ([`c5af6eb`](https://github.com/GitoxideLabs/gitoxide/commit/c5af6eb1f044d1396f23839ecec08bb0e6776fe6))
    - Mildly improve performance in case there is nothing to do for 'organize' ([`4f9fdc5`](https://github.com/GitoxideLabs/gitoxide/commit/4f9fdc5be6eac4ad518469990b3258a40262d337))
    - Fix journey tests by not allowing canonicalization of possibly… ([`532ff2b`](https://github.com/GitoxideLabs/gitoxide/commit/532ff2b9deb491d870b772d91fad0024790e8f59))
    - Avoid claiming we would move something even though we won't (in 'organize') ([`47c7fb3`](https://github.com/GitoxideLabs/gitoxide/commit/47c7fb3bb1a24e5d2fc1aa71f2febe8fe87172d4))
    ...
    - Implement `find` subcommand ([`28d506a`](https://github.com/GitoxideLabs/gitoxide/commit/28d506a6c0df18fc0c2e4a578707203f8e89577d))
    ...
    - Fix tests ([`da94cfc`](https://github.com/GitoxideLabs/gitoxide/commit/da94cfcfa3e745d1174fd9b065f57f56e9f70efe))
    - Thanks clippy ([`de32204`](https://github.com/GitoxideLabs/gitoxide/commit/de32204cdac809fb20c9fe56d5ea6fa828217038))
    - Avoid moving nested repositories out of their place ([`5d7e6bf`](https://github.com/GitoxideLabs/gitoxide/commit/5d7e6bf22af432a3a813daaf485b3a72f64bf257))
    - Recurse into directories much less… ([`87561eb`](https://github.com/GitoxideLabs/gitoxide/commit/87561eb0df8a9da3e0befcdf3d0976cc6a66550d))
    - Better use of jwalk filter capabilities… ([`781ea7f`](https://github.com/GitoxideLabs/gitoxide/commit/781ea7fe00fd48c68c0bdc5e0bf03d47dfce4f63))
    - Optimize number of CPUs for directory walk for M1 chips ([`129a699`](https://github.com/GitoxideLabs/gitoxide/commit/129a69997fb5c50d28fe9340a9b20bab0a69121e))
    ...
    - Prepare to put 'organize' behind a feature flag ([`9986509`](https://github.com/GitoxideLabs/gitoxide/commit/9986509af150a90c4c9271b402fcac419090d9d4))
    - Refactor; planning ([`5df492c`](https://github.com/GitoxideLabs/gitoxide/commit/5df492c7d7322bde2b268deaf590f1ba012a6b8e))
    - Fix progress ([`1abd761`](https://github.com/GitoxideLabs/gitoxide/commit/1abd761670f6b6aba3af10ab4a60c86a3f314f6a))
    - Assure basic 'organize' operation is working as expected ([`deb6073`](https://github.com/GitoxideLabs/gitoxide/commit/deb6073671ae95de674aaef7ca01e03f95b41ca8))
    - A version of organize which works; in theory ([`800a2f4`](https://github.com/GitoxideLabs/gitoxide/commit/800a2f4a488112fbd31882c734889e4841aaa120))
    - A first stab at finding git repositories ([`e4dc964`](https://github.com/GitoxideLabs/gitoxide/commit/e4dc96403894f1fe509335905679347ecdf535c7))
    - Fix verbose parsing unit tests ([`ce38ede`](https://github.com/GitoxideLabs/gitoxide/commit/ce38edee5b8c7f6829fc8050ce3eeffe5943eedf))
    ...
    - Thanks clippy ([`9e93a71`](https://github.com/GitoxideLabs/gitoxide/commit/9e93a71c6664b3d40c9e76811ada81d6e1180bfe))
    - First sketch of parsing git remotes (from git :D) ([`f8ab261`](https://github.com/GitoxideLabs/gitoxide/commit/f8ab261fe77a9339c121e6254a523d09fa339e40))
    - First tiny journey test for dry run of organize subcommand ([`7bbba5a`](https://github.com/GitoxideLabs/gitoxide/commit/7bbba5a76d8cccb527dd6e782b830dbc4ce426bd))
    - Refactor ([`64495b0`](https://github.com/GitoxideLabs/gitoxide/commit/64495b0a6468679d882e5bebda45704891e7bf4e))
    - First sketch of interface for 'organize' subcommand ([`4f64d12`](https://github.com/GitoxideLabs/gitoxide/commit/4f64d1277308bc2281c065236f2f14d66826d14d))
 ...
 * **Uncategorized**
    - (cargo-release) version 0.6.0 ([`4df97ce`](https://github.com/GitoxideLabs/gitoxide/commit/4df97ce6869a53a688b9af18405b284d9ff27b24))
    ...
    - (cargo-release) version 0.5.0 ([`ae9c52b`](https://github.com/GitoxideLabs/gitoxide/commit/ae9c52bdbe43488bb9d5b5448bf07367a1d0a24a))
    ...
    - Refactor ([`8c658da`](https://github.com/GitoxideLabs/gitoxide/commit/8c658da05a4649814eef9f7ab57525aff0605afc))
 ...
 * **Uncategorized**
    - (cargo-release) version 0.4.1 ([`105c501`](https://github.com/GitoxideLabs/gitoxide/commit/105c50132c8ad1f15ace0821278a11b06c81103c))
 ...
 * **Uncategorized**
    - (cargo-release) version 0.4.0 ([`92e8b27`](https://github.com/GitoxideLabs/gitoxide/commit/92e8b273654c3dedce60de244944683c7cf153e7))
    - (cargo-release) version 0.4.0 ([`2b1bca8`](https://github.com/GitoxideLabs/gitoxide/commit/2b1bca83c453544972e370dc0adff57cb7590b42))
    ...
    - Refactor ([`dc022ce`](https://github.com/GitoxideLabs/gitoxide/commit/dc022ce94505ce091e52fd64076bba01f0fe0eb0))
    ...
    - [clone] better JSON output for pack-receive ([`bc6b8e8`](https://github.com/GitoxideLabs/gitoxide/commit/bc6b8e86f258835b6da60ea7e749fe01243a4010))
    - [clone] initial implementation of Json format for pack-receive ([`9090ac6`](https://github.com/GitoxideLabs/gitoxide/commit/9090ac6c6acdb5e050c597a279a963b48c08871a))
    - [clone] nicer pack-receive output for humans ([`09c6c57`](https://github.com/GitoxideLabs/gitoxide/commit/09c6c576ddb4c791b1b5f9b1812485e73a080f93))
    - [clone] Don't hide nested pack-decoding information ([`4d4be97`](https://github.com/GitoxideLabs/gitoxide/commit/4d4be975707d017a67a0b2c081a07c4092b2801d))
    ...
    - [clone] First step towards implementing a working pack receiving… ([`264ec82`](https://github.com/GitoxideLabs/gitoxide/commit/264ec821ca92a08d1756222abab11ffebb6dc0ff))
    ...
    - [ref-ls] usable JSON output ([`735ae50`](https://github.com/GitoxideLabs/gitoxide/commit/735ae50c1fdf1a7c403782f40b5234ea881da7b1))
    ...
    - [ref-ls] first actual call of ls-remote, but… ([`5fc4330`](https://github.com/GitoxideLabs/gitoxide/commit/5fc4330eca42a0a3ba6c14fe8c27aeda16e440ec))
 ...
 * **Uncategorized**
    ...
    - First sketch of gitoxide index::from_pack(…) ([`da0eace`](https://github.com/GitoxideLabs/gitoxide/commit/da0eacea838a0fcdf09e052334f944269a153f42))
    - Refactor; better tests ([`12d14bf`](https://github.com/GitoxideLabs/gitoxide/commit/12d14bfe2aa089723a395287c5100aad6e838935))
    - Update tasks ([`45c3520`](https://github.com/GitoxideLabs/gitoxide/commit/45c352009092dbfd80bcb3e367d848d5b10737d4))
    ...
    - Most tests and clearer error message if object directory is inaccessible ([`1d8f597`](https://github.com/GitoxideLabs/gitoxide/commit/1d8f5974a5c754750f46697370cb2551f6660666))
    ...
    - Don't uncondionally delete packs/indices on explode :D ([`1979715`](https://github.com/GitoxideLabs/gitoxide/commit/19797156bafbacbaf0a53d01d72bbe86881aea9b))
 ...
 * **Uncategorized**
    ...
    - Pass serde1 through from gitoxide ([`1991b9f`](https://github.com/GitoxideLabs/gitoxide/commit/1991b9ffef1a2b9a402d080d0a31e0857c434bc4))
    - Don't print 'OK' at the end of verify-pack ([`4956ef2`](https://github.com/GitoxideLabs/gitoxide/commit/4956ef23783104d64c35983934c69db918f3027a))
    ...
    - Pretty-print objects per delta chain length ([`66553b1`](https://github.com/GitoxideLabs/gitoxide/commit/66553b1c544a25c9703641ab6ea1a4a2a08b945a))
    ...
    - Pretty-printing of some statistics ([`125b565`](https://github.com/GitoxideLabs/gitoxide/commit/125b565f0fb4085c615fdf136f35a2285d69966a))
    ...
    - First basic index file verification ([`994700f`](https://github.com/GitoxideLabs/gitoxide/commit/994700f96b058a0910e734bdecced44bd0a7ea5d))
    ...
    - Rename grit to 'gitoxide', CLI name is 'gio' ([`9d6007f`](https://github.com/GitoxideLabs/gitoxide/commit/9d6007f83b3b018d736d58aa0722b83b9cffb228))
    ...
    - Fix CI ([`9ea88b6`](https://github.com/GitoxideLabs/gitoxide/commit/9ea88b60aea5d2ed35c57e741807d9a6ea69f351))
    - Make included files independent of tests ([`3ee852a`](https://github.com/GitoxideLabs/gitoxide/commit/3ee852ae247de539a537bc0c0068c39859bf288d))
    ...
    - Fix git init to match latest git version ([`6bfea63`](https://github.com/GitoxideLabs/gitoxide/commit/6bfea63b563149501176d915eb9f872a3eba2b40))
