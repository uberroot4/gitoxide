 ...
 * **Uncategorized**
    ...
    - Assure empty paths are always matching a `Search` ([`5b47567`](https://github.com/GitoxideLabs/gitoxide/commit/5b47567bff0b46cb1b6e933bf7ebdb75909bb2ba))
...
### Bug Fixes
 ...
 - <csr-id-038687127ac6eecdd229fe054df3c050612837cd/> `Search::can_match_relative_path()` won't report false-negatives anymore.
 ...
 * **Uncategorized**
    ...
    - `Search::can_match_relative_path()` won't report false-negatives anymore. ([`0386871`](https://github.com/GitoxideLabs/gitoxide/commit/038687127ac6eecdd229fe054df3c050612837cd))
</details>
 ...
 * **Uncategorized**
    ...
    - Assure that `..` patterns don't end up being `.` that matches nothing ([`5f21e24`](https://github.com/GitoxideLabs/gitoxide/commit/5f21e24a3d8c98e726d822d2961978d729e66e43))
    - Add `Search::prefix_directory()` and `Search::longest_common_directory()`. ([`57f0a24`](https://github.com/GitoxideLabs/gitoxide/commit/57f0a24d78ce43b69631e05688cc7ac900cfe1cb))
    ...
    - Return `ExactSizeIterator` where applicable. ([`ea2e5bb`](https://github.com/GitoxideLabs/gitoxide/commit/ea2e5bbc4657aba5d2209d9f22fa076148d5df6f))
    - Add `Search::directory_matches_prefix()` to see if the prefix of a pathspec matches. ([`f520a51`](https://github.com/GitoxideLabs/gitoxide/commit/f520a516e712566cba47ff983cd0f2f3faf6286a))
    - Add `search::MatchKind`, which is available for any `search::Match`. ([`021d4c1`](https://github.com/GitoxideLabs/gitoxide/commit/021d4c185525e9b289462bf23811fcaa283d8bef))
    - Add `Search::can_match_relative_path()`. ([`e409e8d`](https://github.com/GitoxideLabs/gitoxide/commit/e409e8d35075721f57dedca5e65ecd110bd2a5ec))
 ...
 * **Uncategorized**
    ...
    - Merge branch 'fuzz-gix-pathspec' ([`62e1072`](https://github.com/GitoxideLabs/gitoxide/commit/62e1072b28b965cfaa4d25831d9b8a12bb7c67c2))
    - Fuzz more of pathspec patterns ([`6ac89e5`](https://github.com/GitoxideLabs/gitoxide/commit/6ac89e56ffbe66c6d06d79847e0b51e1046507dc))
</details>
 ...
 * **Uncategorized**
    ...
    - Improve documentation of `common_prefix()` and `pattern_matching_relative_path()`. ([`832b345`](https://github.com/GitoxideLabs/gitoxide/commit/832b34570bde97499e75a174bc818113092b3145))
</details>
...
<csr-read-only-do-not-edit/>
 ...
 - 169 commits contributed to the release.
 - 12 commits were understood as [conventional](https://www.conventionalcommits.org).
 - 5 unique issues were worked on: [#301](https://github.com/GitoxideLabs/gitoxide/issues/301), [#415](https://github.com/GitoxideLabs/gitoxide/issues/415), [#427](https://github.com/GitoxideLabs/gitoxide/issues/427), [#450](https://github.com/GitoxideLabs/gitoxide/issues/450), [#691](https://github.com/GitoxideLabs/gitoxide/issues/691)
 ...
 * **[#301](https://github.com/GitoxideLabs/gitoxide/issues/301)**
    - Add future crate for good measure ([`625eb1d`](https://github.com/GitoxideLabs/gitoxide/commit/625eb1d7d266036c1f30caab7bd3897af9fdbef7))
 * **[#415](https://github.com/GitoxideLabs/gitoxide/issues/415)**
    - Changed quickerror to thiserror ([`49fcab7`](https://github.com/GitoxideLabs/gitoxide/commit/49fcab749ea3260f3333976567fcc4ab8a072fe3))
    - Added alternative parsing module ([`eb2dec0`](https://github.com/GitoxideLabs/gitoxide/commit/eb2dec0777bfe894f4d02bdc03a3e507302b41b4))
    - Attribute parsing functional ([`4b2ed7e`](https://github.com/GitoxideLabs/gitoxide/commit/4b2ed7e0f033fd01a7364fc41057e113adf2fbdc))
    - Updated documentation ([`8b9570f`](https://github.com/GitoxideLabs/gitoxide/commit/8b9570fdcdb426cbde7edb9fcca4b7340944550e))
    - Attribute parsing WIP ([`7c84fb8`](https://github.com/GitoxideLabs/gitoxide/commit/7c84fb81506cc41fbf68575583129eafbd89139d))
    - Added some documentation ([`c04d4be`](https://github.com/GitoxideLabs/gitoxide/commit/c04d4be29c7a0cf72500d30432215513f6066338))
    - Tests now check if pathspec is valid in git ([`334659e`](https://github.com/GitoxideLabs/gitoxide/commit/334659e34b1f99f3bc662fa599dcd8f0d94ad206))
    - Remove WhitespaceError ([`4d20cd9`](https://github.com/GitoxideLabs/gitoxide/commit/4d20cd91be403d48fd5443202048f4a5bb867a62))
    - Error handling: parser can return a result now ([`31aba11`](https://github.com/GitoxideLabs/gitoxide/commit/31aba11c953b5b7dd70f14ee904026d12db69d10))
    - Pathspec parser is functional ([`7d95f16`](https://github.com/GitoxideLabs/gitoxide/commit/7d95f162a3edb7b2714dfadb9b5cf8311f3da061))
 ...
 * **Uncategorized**
    ...
    - Export `gix-attributes` as `attributes` to make `gix-glob` and `gix-attribute` types available. ([`07a3e93`](https://github.com/GitoxideLabs/gitoxide/commit/07a3e93d22462ed0221ee90bda17559425305528))
    - Add `Defaults::from_environment()` to be able to respect git environment settings. ([`fb9d4db`](https://github.com/GitoxideLabs/gitoxide/commit/fb9d4db3fe304e9411a6651b128a25da260fce62))
    - Certain combinations of exclude specs could cause panics. ([`a2f1879`](https://github.com/GitoxideLabs/gitoxide/commit/a2f1879f85df75146baf32336cf5a7b19dae032e))
    ...
    - Match pathspecs just like `git` does. ([`49db3ac`](https://github.com/GitoxideLabs/gitoxide/commit/49db3ac81db18fbc492d14161c09084112ff62f3))
    - `parse()` now supports the configuration of defaults. ([`f1421d3`](https://github.com/GitoxideLabs/gitoxide/commit/f1421d31ab9e045f6b6599d21eb1a0723f90a242))
    - Add `Pattern::is_null()` to be able to check for a special kind of spec. ([`b3de72e`](https://github.com/GitoxideLabs/gitoxide/commit/b3de72e014b33bdf1ebc39cd7e3e5db990e5b7f3))
    - Refactor ([`5f76ddf`](https://github.com/GitoxideLabs/gitoxide/commit/5f76ddf0a5158ba5503a8a39b09336655eeb5156))
    ...
    - Adjust to renaming of `git-pathspec` to `gix-pathspec` ([`37f7c6b`](https://github.com/GitoxideLabs/gitoxide/commit/37f7c6b9070e118604aa3fc0b38530699dcfec6e))
    - Renmae `git-pathspec` to `gix-pathspec` ([`a49ba33`](https://github.com/GitoxideLabs/gitoxide/commit/a49ba33f7aa22e39b4177320224ee99353b7540b))
    ...
    - Avoid another vec allocation by inlining code via closure. ([`d88952a`](https://github.com/GitoxideLabs/gitoxide/commit/d88952a533cf2fa2ebf0f015b10f5983a1c8f144))
    - Avoid temporary vec in favor of a `&'static [u8]`. ([`5a55dbf`](https://github.com/GitoxideLabs/gitoxide/commit/5a55dbf5fd2ae8c28d95d72d55a30e4e7e2ef9cf))
    ...
    - Assure all baseline samples are validated ([`4899722`](https://github.com/GitoxideLabs/gitoxide/commit/489972209ee2ead2871ca2410bd10e51019dc9ad))
    - Add documentation; rename `SearchMode` to `MatchMode`; add test ([`4f6fa59`](https://github.com/GitoxideLabs/gitoxide/commit/4f6fa59d20b4e03663f3d7c3819a7d02b79ab982))
    - Add basic docs for how to run the fuzzer ([`0c9bef4`](https://github.com/GitoxideLabs/gitoxide/commit/0c9bef47a70a0787b63f9bf8e9b52f2ab9f72738))
    - Rename `parser` fuzz target to `parse` ([`ef03823`](https://github.com/GitoxideLabs/gitoxide/commit/ef03823b407bcdbac16c42e941809dfe7cde850b))
    - Refactor ([`1cbc142`](https://github.com/GitoxideLabs/gitoxide/commit/1cbc142d37599f4d7bfaf9cb07de41ee4b3f4c24))
    - Update crate status and READMe ([`07352ce`](https://github.com/GitoxideLabs/gitoxide/commit/07352ceb942dac5041fbf8584128404880166593))
    - Refactor ([`63baa75`](https://github.com/GitoxideLabs/gitoxide/commit/63baa752901388a46a4211c70f3b3a64aa36d4ec))
    - Add readme file ([`913d94c`](https://github.com/GitoxideLabs/gitoxide/commit/913d94c3c226aac321de12eb7ae8bfa3ee3458e9))
    - Remove prefix stuff ([`b7baaa5`](https://github.com/GitoxideLabs/gitoxide/commit/b7baaa5353aa52ca97488993b50cef72248387de))
    ...
    - Refactor ([`bffbcee`](https://github.com/GitoxideLabs/gitoxide/commit/bffbcee68affce2a829c67bfe71e7df861c15ee5))
    - Fix unescaping logic - thanks fuzzer ([`9c6281f`](https://github.com/GitoxideLabs/gitoxide/commit/9c6281f903451011407a352e1fca877d79c10466))
    - Add fuzzer ([`2a775c6`](https://github.com/GitoxideLabs/gitoxide/commit/2a775c602da3edf20d84599839ca166bff2457a5))
    - Check attr values regarless of it being escaped ([`6e93144`](https://github.com/GitoxideLabs/gitoxide/commit/6e93144545277cb5efe1dd3fba2ecaf90ea9c726))
    ...
    - Help type inference ([`4d6befd`](https://github.com/GitoxideLabs/gitoxide/commit/4d6befdbad72d1d143edd344cc7e9e0cba1d1e8a))
    - Fix build ([`1838f3d`](https://github.com/GitoxideLabs/gitoxide/commit/1838f3db13eae6d278264dcdbc48d202de992349))
    - Refactor ([`1bdf2e1`](https://github.com/GitoxideLabs/gitoxide/commit/1bdf2e1d1b8f58ed2d6fe21c62edb93fc5473c14))
    - Refactor ([`850bcc3`](https://github.com/GitoxideLabs/gitoxide/commit/850bcc35f0e99ef1d65c6bd888638b9a67cab25b))
    - Refactor ([`65c8349`](https://github.com/GitoxideLabs/gitoxide/commit/65c83491281184161ad6d9831adabb8475722e42))
    - Refactor attribute value unnescaping ([`24592f7`](https://github.com/GitoxideLabs/gitoxide/commit/24592f7a4f6188d3bb0042f9e91dffc5fc01e382))
    ...
    - Improved attribute value unescaping ([`1f89646`](https://github.com/GitoxideLabs/gitoxide/commit/1f89646fc359f94ee001f5ed01623e5af7934a93))
    ...
    - Refactor ([`852bcc3`](https://github.com/GitoxideLabs/gitoxide/commit/852bcc316382fce5f5749942ecb43a73738ffe8f))
    ...
    - Refactor ([`1ad98e8`](https://github.com/GitoxideLabs/gitoxide/commit/1ad98e82f66c5f5eacb15f8ae38d8ccb1bc94e9e))
    - Escape attribute values in pathspec crate... ([`c22e57f`](https://github.com/GitoxideLabs/gitoxide/commit/c22e57f8e4131655595da2b81662e23258bb85c8))
    - Refactor ([`7f00b50`](https://github.com/GitoxideLabs/gitoxide/commit/7f00b50070c7b976a030ec836d2660ff5b7b5f72))
    - Refactor ([`2523f96`](https://github.com/GitoxideLabs/gitoxide/commit/2523f9606f0adedb20ac93cf4853298bcd996118))
    - Refactor ([`699de03`](https://github.com/GitoxideLabs/gitoxide/commit/699de03f0c981a9f8b5239c66dc425e504de1ec2))
    - Refactor ([`7f93231`](https://github.com/GitoxideLabs/gitoxide/commit/7f93231b4983f9ce596cea84ad4525feb3778dd6))
    - Refactor ([`02fba2c`](https://github.com/GitoxideLabs/gitoxide/commit/02fba2c124f3665112102469d41d476b6cf48dcd))
    - Improved testing against the baseline ([`44991d3`](https://github.com/GitoxideLabs/gitoxide/commit/44991d373bd2e2f71ccf27eabe9f074cb5fe7c18))
    - Refactor ([`020bc24`](https://github.com/GitoxideLabs/gitoxide/commit/020bc24973233edc261e05fd9935c5e598bf2922))
    - Refactor ([`b490b4a`](https://github.com/GitoxideLabs/gitoxide/commit/b490b4a7be579941c2664fbefb25dd341ed7d1e7))
    - More testcases related to escape chars - still todo ([`f606515`](https://github.com/GitoxideLabs/gitoxide/commit/f606515dfd89e28c78eaead3cf5023d5064618f5))
    - No splitting on escaped commas in attribute values ([`c0196fa`](https://github.com/GitoxideLabs/gitoxide/commit/c0196fa363088426de031e55b982f70573ab738d))
    - Thanks clippy ([`f80eb85`](https://github.com/GitoxideLabs/gitoxide/commit/f80eb851ab56b4580eb28935978487b9f37fe819))
    - Remove attr from signature bitflag ([`998415d`](https://github.com/GitoxideLabs/gitoxide/commit/998415d9a3a234787c017bd448410a24ad4965f0))
    - Refactor ([`149d1b3`](https://github.com/GitoxideLabs/gitoxide/commit/149d1b36f93d98002175cda362d50bac584c691a))
    - Whitespace test added ([`eecd388`](https://github.com/GitoxideLabs/gitoxide/commit/eecd388708017414fee9077066f24124d83b70ba))
    - Refactor ([`476fa56`](https://github.com/GitoxideLabs/gitoxide/commit/476fa56993391410fc0bafeccfcb8d4da8168bfc))
    - Add more test cases ([`9ceea27`](https://github.com/GitoxideLabs/gitoxide/commit/9ceea2718a63bdd55ea8b99c2f1656cc09850145))
    - Thanks clippy ([`f7a3b69`](https://github.com/GitoxideLabs/gitoxide/commit/f7a3b69e43e82471047091008355d180e646773d))
    - Added more tests ([`476f31c`](https://github.com/GitoxideLabs/gitoxide/commit/476f31c0f0fc7b29d02110e3a9b9a542defce63e))
    - Refactor ([`d3ec61a`](https://github.com/GitoxideLabs/gitoxide/commit/d3ec61a2fcc6d8269cb952def86a198a7ac9492e))
    - Refactor ([`5a3c0fe`](https://github.com/GitoxideLabs/gitoxide/commit/5a3c0fe8d56e9bc28eda77d3d64ef5338365622c))
    - Refactor ([`162f9a0`](https://github.com/GitoxideLabs/gitoxide/commit/162f9a06860fac69e6db6d76dc5051ec2e6ed2db))
    - Pattern now has searchmode... ([`0bed938`](https://github.com/GitoxideLabs/gitoxide/commit/0bed9382930486af144876d97b97479e03e0f1c1))
    - Test refactor and bug fixes ([`57d8d90`](https://github.com/GitoxideLabs/gitoxide/commit/57d8d90d246226fc9119612d10d31808f8fa3053))
    - Pattern uses MagigSignature without Option ([`f1f4ab3`](https://github.com/GitoxideLabs/gitoxide/commit/f1f4ab3e3f50d00db4756ea724e5fd1b8ee75a04))
    - Error tests now use matches! ([`6a569a7`](https://github.com/GitoxideLabs/gitoxide/commit/6a569a70d15c416f91ab20083747e25f867f7446))
    - Refactor ([`13b7db5`](https://github.com/GitoxideLabs/gitoxide/commit/13b7db526c0a56360998a731ba10a7b4990d9529))
    - Refactor ([`2690b8a`](https://github.com/GitoxideLabs/gitoxide/commit/2690b8a73c39175ccfddd098c1f72f2cdee048cf))
    ...
    - Hint for how to make a functional version bearable… ([`e8da186`](https://github.com/GitoxideLabs/gitoxide/commit/e8da18663d5110c87200287a1bc0d1b6f86cf0f9))
    - Refactor ([`a0477e9`](https://github.com/GitoxideLabs/gitoxide/commit/a0477e9b1fdf6ef289208a77f0539ea090c84e79))
    - Refactor ([`d109cfe`](https://github.com/GitoxideLabs/gitoxide/commit/d109cfead637b0b2c2866fb411eeccbf6a5bff2c))
    - Refactor ([`fbed980`](https://github.com/GitoxideLabs/gitoxide/commit/fbed980797057efb22140e8ff371989d49cc2a73))
    - Initial setup of pathspec module ([`fece972`](https://github.com/GitoxideLabs/gitoxide/commit/fece9725d60201b16b67073c185195b88fa1ad20))
    - Release git-pathspec v0.0.0 ([`d6bee3f`](https://github.com/GitoxideLabs/gitoxide/commit/d6bee3f931741906126a800aec9d43bc6bf8690f))
</details>
