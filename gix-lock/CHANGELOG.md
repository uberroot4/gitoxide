 ...
 * **Uncategorized**
    ...
    - Add `*_with_permissions(..., permissions)` methods. ([`719fc81`](https://github.com/GitoxideLabs/gitoxide/commit/719fc81fa72756faa13fc3f8d4759df5d40cebd0))
    - When obtaining locks, use mode 666 on Linux by default. ([`d83e45d`](https://github.com/GitoxideLabs/gitoxide/commit/d83e45de625587b7b11e376a4d608854027a723e))
</details>
...
### New Features
 ...
 - <csr-id-fda433757e3cd6645edfd2e18dcd2e67d1ef930f/> Make it easy to configure lock acquisition failure from Duration.
   Now `Duration` can be turned into `acquire::Fail`.

### Other

- <csr-id-ae298262add18049969f9451ed2a704d248eed41/> make clear that locks can leak and what that means on acquiring a lock
 ...
 * **[#1026](https://github.com/GitoxideLabs/gitoxide/issues/1026)**
    - Make clear that locks can leak and what that means on acquiring a lock ([`ae29826`](https://github.com/GitoxideLabs/gitoxide/commit/ae298262add18049969f9451ed2a704d248eed41))
 * **Uncategorized**
    ...
    - Make it easy to configure lock acquisition failure from Duration. ([`fda4337`](https://github.com/GitoxideLabs/gitoxide/commit/fda433757e3cd6645edfd2e18dcd2e67d1ef930f))
</details>
 ...
 * **Uncategorized**
    ...
    - Thanks clippy ([`908468b`](https://github.com/GitoxideLabs/gitoxide/commit/908468bf9c2e7593b4902c50c2df72bcc9d2af78))
</details>
 ...
 * **Uncategorized**
    ...
    - Prepare changelog prior to release ([`fcadd20`](https://github.com/GitoxideLabs/gitoxide/commit/fcadd20205f51ed9e9acbabfa5f0a284d11e1e94))
    - Unify `gix-utils` version... ([`6b6eaf9`](https://github.com/GitoxideLabs/gitoxide/commit/6b6eaf9401d78684350a8eb0ec337fda7a5ae19b))
</details>
 ...
 * **Uncategorized**
    ...
    - Replace `quick-error` with `thiserror` ([`d08364c`](https://github.com/GitoxideLabs/gitoxide/commit/d08364ce7eb00b052202b623dad92cfda38b812f))
...
<csr-read-only-do-not-edit/>
 ...
 - 149 commits contributed to the release.
 - 7 commits were understood as [conventional](https://www.conventionalcommits.org).
 - 6 unique issues were worked on: [#198](https://github.com/GitoxideLabs/gitoxide/issues/198), [#301](https://github.com/GitoxideLabs/gitoxide/issues/301), [#364](https://github.com/GitoxideLabs/gitoxide/issues/364), [#384](https://github.com/GitoxideLabs/gitoxide/issues/384), [#386](https://github.com/GitoxideLabs/gitoxide/issues/386), [#691](https://github.com/GitoxideLabs/gitoxide/issues/691)
 ...
 * **[#301](https://github.com/GitoxideLabs/gitoxide/issues/301)**
    ...
    - Refactor ([`287f47c`](https://github.com/GitoxideLabs/gitoxide/commit/287f47c17a52be382f0866abaa0db6b33a09f560))
 ...
 * **[#384](https://github.com/GitoxideLabs/gitoxide/issues/384)**
    - Export git-tempfile in the root ([`a789490`](https://github.com/GitoxideLabs/gitoxide/commit/a789490fbbba1f44d79d57c8ba74bf40c600faf2))
 * **[#386](https://github.com/GitoxideLabs/gitoxide/issues/386)**
    - Interpret `PermissionDenied` as reason to retry on lock acquisition failure. ([`73ecb40`](https://github.com/GitoxideLabs/gitoxide/commit/73ecb40bb20f9c3fe7341f4ff1b0b81ac09b9ae0))
 ...
 * **Uncategorized**
    ...
    - Rename `git-lock` to `gix-lock` ([`0422433`](https://github.com/GitoxideLabs/gitoxide/commit/04224336b910fbcb8c32ef61edb345c53e945425))
    ...
    - Add `backoff` for an exponential backoff iterator. ([`f9bb71b`](https://github.com/GitoxideLabs/gitoxide/commit/f9bb71b984045a069f7caf0c650ef24bd3cc0be1))
    ...
    - Merge branch 'main' into git-sec ([`2fe70f9`](https://github.com/GitoxideLabs/gitoxide/commit/2fe70f96cfb68e108637ce78f8edda2eb4e2e61a))
    - Merge branch 'main' into repo-status ([`8122c5c`](https://github.com/GitoxideLabs/gitoxide/commit/8122c5c8a122e5297832f96c07a6fb1a5df02620))
    ...
    - Release git-lock v0.3.2 ([`a5ea2e7`](https://github.com/GitoxideLabs/gitoxide/commit/a5ea2e7ba4bac484fad0672811ecd303214d8425))
    ...
    - (cargo-release) version 0.3.1 ([`168f5a0`](https://github.com/GitoxideLabs/gitoxide/commit/168f5a0c5e9fdaf56789c884853569c5b850d7fa))
    - [lock #154] add io impls for `File` ([`be62a8b`](https://github.com/GitoxideLabs/gitoxide/commit/be62a8bbe6c643017816ea23f15f04d38eb98b46))
    ...
    - Bump fastrand from 1.4.1 to 1.5.0 ([`b138b43`](https://github.com/GitoxideLabs/gitoxide/commit/b138b437b9fb57f5df8bd582ac288ffac00df8cd))
    - [ref] fix docs ([`536555d`](https://github.com/GitoxideLabs/gitoxide/commit/536555d66705175d83ba411392b049c8ed736ee9))
    ...
    - [lock] refactor ([`48861b2`](https://github.com/GitoxideLabs/gitoxide/commit/48861b23406bbeee33081b32b2a528533997910d))
    - [lock] FAIL: trying to make peristence recoverable… ([`1fcdd1e`](https://github.com/GitoxideLabs/gitoxide/commit/1fcdd1e5da51fe8f15e9bfab86b22a82ef936bcc))
    ...
    - [lock] access to the locked resource path ([`797bafa`](https://github.com/GitoxideLabs/gitoxide/commit/797bafaa0a83449be2acb647f875a67476548afe))
    - [lock] allow accessing the lock file path more easily ([`b808b00`](https://github.com/GitoxideLabs/gitoxide/commit/b808b00f62f587679ffbfe9e465b33419cdd5879))
    - [lock] Fix handling of .lock extension on files without extension ([`64ac60d`](https://github.com/GitoxideLabs/gitoxide/commit/64ac60d82db9bd81ceed2f0f1167c196de340ffe))
    - [lock] close file lock and commit markers ([`f700821`](https://github.com/GitoxideLabs/gitoxide/commit/f7008214497d3a80ffcd62840854f3db65c563a9))
    - [lock] Marker commit with runtime check for protection ([`b747814`](https://github.com/GitoxideLabs/gitoxide/commit/b74781403716e5156dad06ecf5cf83ff72262161))
    - (cargo-release) version 0.1.0 ([`60d48b0`](https://github.com/GitoxideLabs/gitoxide/commit/60d48b0d008ca3b8612fd7b7e70b89b4bdb52b2c))
    ...
    - [lock] capture amount of attempts taken when obtaining a lock ([`7fafa3e`](https://github.com/GitoxideLabs/gitoxide/commit/7fafa3e70a26c040e2f50c477df314eccf90a42f))
    - [lock] validate error message when waiting for some tim ([`34d3c5a`](https://github.com/GitoxideLabs/gitoxide/commit/34d3c5a357c33e6734714cbbe8f6065b59f1215e))
    - [lock] the first test for lock failure (immediate mode) ([`2d67a0e`](https://github.com/GitoxideLabs/gitoxide/commit/2d67a0e3948e717df0cc4de58686f5efa3645be9))
    ...
    - Thanks clippy ([`29782e8`](https://github.com/GitoxideLabs/gitoxide/commit/29782e8c32d0b062e33a77bd4d639438e88b91b4))
    - [lock] lock acquire with backoff, but without test for now ([`bb2ba81`](https://github.com/GitoxideLabs/gitoxide/commit/bb2ba81b2723cca11b4d98efa176ce5d184ab594))
    - [lock] prevent flakyness due to rounding or something ([`6f8fbcc`](https://github.com/GitoxideLabs/gitoxide/commit/6f8fbcc197446068b680ea4c41e79bfc6356fcff))
    - [lock] refactor ([`ddc2170`](https://github.com/GitoxideLabs/gitoxide/commit/ddc2170498d3822ebf6fc35e2e4b336f7af6d9f3))
    - [lock] remaining test for everything proper exponential backoff needs ([`368d994`](https://github.com/GitoxideLabs/gitoxide/commit/368d9944b2b3379b0d01be93aea02cae25d1c867))
    - [lock] support for randomization ([`220eb99`](https://github.com/GitoxideLabs/gitoxide/commit/220eb9945b2006f79b82d80eaabd09b5e291953b))
    - [lock] better overshoot test for exponential backoff ([`62c17d8`](https://github.com/GitoxideLabs/gitoxide/commit/62c17d8721a8d797fe7475ea36a90931e835ebc4))
    - [lock] a sketch of exponential backoff, without rnadomization ([`55670b4`](https://github.com/GitoxideLabs/gitoxide/commit/55670b458d248f6249f0031ec73c5eb4f72e36f7))
    ...
    - [lock] creation of lockfiles, with immediate failure mode ([`fda7da8`](https://github.com/GitoxideLabs/gitoxide/commit/fda7da8ec43f7999effdfd76791a6541f8c52338))
    ...
    - [lock] even more sketched out API ([`0dc88c9`](https://github.com/GitoxideLabs/gitoxide/commit/0dc88c9c42690a3e8320fe5b701c51eed8747118))
